...
<head about=" ">
    <meta charset="utf-8">
    <title>CC0 1.0 Univerzalna</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/CC0/1.0/legalcode.sl" aria-current="page displayed">Legal Code for CC0 1.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/CC0/1.0/deed.sl">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">CC0 1.0 Univerzalna</a>
      ...
      <li>
        <ul>
          ...
          <li class="columns">
            ...
            <a class="is-block column" href="#sop">Izjava o nameri</a>
          </li>
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
            <a class="is-block column" href="#copyright">1. Avtorske in sorodne pravice.</a>
          </li>
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
            <a class="is-block column" href="#waiver">2. Odpoved pravicam.</a>
          </li>
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
            <a class="is-block column" href="#fallback">3. Rezervna javna licenca.</a>
          </li>
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
            <a class="is-block column" href="#limitations">4. Omejitve in opozorila.</a>
          </li>
...
></i>
  ...
  <h1 class="b-header">CC0 1.0 Univerzalna</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">CC0 1.0 Univerzalna</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">CC0 1.0 Univerzalna</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">CC0 1.0 Univerzalna</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons CC0 1.0 Univerzalna</h3>
  ...
  <div class="padding-bottom-larger">
    ...
    <div id="sop" class="padding-bottom-larger">
      <p class="body-bigger padding-bottom-normal"><strong>Izjava o nameri</strong></p>

      <p class="body-big padding-bottom-normal">Zakonodaja večine držav na svetu avtorju in kasnejšim imetnikom (v nadaljevanju: “imetnik”) avtomatično podeljuje izključno Avtorsko in sorodne pravice (definirano spodaj) na izvirnem avtorskem delu in/ali podatkovni bazi (v nadaljevanju: “Delo”).</p>
      <p class="body-big padding-bottom-normal">Nekateri imetniki želijo trajno odstopiti te pravice na Delu za namene prispevanja v skupnostni korpus ustvarjalnih, kulturnih in znanstvenih del (v nadaljevanju: “Skupnostni korpus”), na katerih lahko javnost zanesljivo in brez bojazni, da bo prihajalo do kasnejših zahtevkov iz naslova kršitev, gradi, jih predela, vključi v druga dela, ponovno uporabi in ponovno distribuira, svobodno, v kakršnikoli obliki in za kakršnekoli namene, tudi za komercialne namene. Ti imetniki lahko prispevajo svoja Dela v Skupnostni korpus za namene spodbujanja svobodne kulture in nadaljne izdelave ustvarjalnih, kulturnih in znanstvenih del, ali za pridobivanje ugleda ali širše distribucije njihovih Del deloma preko uporabe in prizadevanj drugih.</p>
      <p class="body-big padding-bottom-normal">Oseba, ki Delo da na voljo pod pogoji CC0 (v nadaljevanju: “Izjavitelj”), kolikor je imetnik Avtorskih in sorodnih pravic na Delu, za zgoraj navedene in/ali ostale namene in vzgibe, brez pričakovanj po dodatnem plačilu ali dodatnem nadomestilu, prostovoljno določi, da se uporabi CC0 na Delu in da se Delo javno distribuira pod pogoji CC0, pri čemer se zaveda svojih Avtorskih in sorodnih pravic na delu ter pomena in predvidenega pravnega učinka CC0 na pravice.</p>
    </div>
      ...
      <div id="copyright" class="padding-bottom-larger">
        <p class="body-bigger padding-bottom-normal"><strong>1. Avtorske in sorodne pravice.</strong></p>

        <p class="body-big padding-bottom-normal">Delo, ki je dano na voljo pod CC0 je lahko varovano z Avtorsko in sorodnimi pravicami, kar vključuje, ni pa omejeno na naslednje pravice:</p>

        <ol type="a" class="body-big padding-left-normal">
          <li class="padding-left-normal padding-bottom-normal">pravica reproduciranja, predelave, distribuiranja, izvajanja, prikazovanja, priobčevanja in prevajanja Dela;</li>
          <li class="padding-left-normal padding-bottom-normal">moralne pravice, ki jih prvotni avtor(ji) in/ali izvajalec(i) obdrži(jo);</li>
          <li class="padding-left-normal padding-bottom-normal">pravica do zasebnosti in druge osebnostne pravice, ki se nanašajo na podobo osebe, prikazane v Delu;</li>
          <li class="padding-left-normal padding-bottom-normal">pravice, ki varujejo pred nelojalno konkurenco v povezavi z Delom, ob upoštevanju omejitev v odstavku 4(a) spodaj;</li>
          <li class="padding-left-normal padding-bottom-normal">pravice, ki varujejo izvlečke, razširjanje in uporabo podatkov v Delu;</li>
          <li class="padding-left-normal padding-bottom-normal">pravice na podatkovnih bazah (kot so predvidene v Direktivi 96/9/ES Evropskega parlamenta in Sveta z dne 11. marca 1996 o pravnem varstvu baz podatkov ali v nacionalni implementacijski zakonodaji, vključno z morebitnimi spremembami ali kasnejšimi verzijami direktive); in</li>
          <li class="padding-left-normal padding-bottom-normal">ostalimi podobnimi, enakovrednimi ali ustreznimi pravicami po svetu v skladu s pravom, ki se uporablja, ali sporazumom in nacionalno implementacijsko zakonodajo.</li>
        </ol>
      </div>
      ...
      <div id="limitations" class="padding-bottom-larger">
        <p class="body-bigger padding-bottom-normal"><strong>4. Omejitve in opozorila.</strong></p>

        <ol type="a" class="body-big padding-left-normal">
          <li class="padding-bottom-normal">
            <div class="padding-left-normal">Izjavitelj se s tem dokumentom ne odpoveduje, opušča, predaja, licencira ali na kakršenkoli drug način vpliva na pravice iz svojih znamk in patentov.</div>
          </li>
          <li class="padding-bottom-normal">
            <div class="padding-left-normal">Izjavitelj ponuja Delo “kot je” in ne daje nobenih izrecnih, implicitnih, zakonskih ali drugačnih zagotovil in jamstev glede Dela, vključno z jamstvi glede pravnih napak, primernosti za prodajo, primernosti za določen namen, kršitev pravic, odsotnosti skritih ali drugih okvar, točnosti ter glede prisotnosti ali odsotnosti napak, znanih ali neznanih, odkritih ali takšnih, ki jih ni mogoče odkriti, v največjem obsegu, ki je dovoljen v skladu s pravom, ki se uporablja.</div>
          </li>
          <li class="padding-bottom-normal">
            <div class="padding-left-normal">Izjavitelj ne prevzema odgovornosti za razčiščevanje pravic tretjih v zvezi z Delom ali kakršnokoli uporabo Dela, vključno z Avtorskimi in sorodnimi pravicami tretjih. Poleg tega Izjavitelj ne prevzema odgovornosti za pridobivanje potrebnih soglasij, dovoljenj ali drugih pravic, ki so potrebne za uporabo Dela.</div>
          </li>
          <li class="padding-bottom-normal">
            <div class="padding-left-normal">Izjavitelj razume in se zaveda, da Creative Commons ni stranka tega dokumenta in da nima dolžnosti ali obveznosti v zvezi s CC0 ali uporabo Dela.</div>
          </li>
        </ol>
      </div>
    </div>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/CC0/1.0/legalcode.sl.txt" class="link">View Legal Code as plain text</a></p>
</div>
