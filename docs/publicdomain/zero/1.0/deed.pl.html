...
<li class="is-active"><a href="/licenses/CC0/1.0/deed.pl" aria-current="page displayed">License Deed for CC0 1.0</a></li>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/CC0/1.0/legalcode.pl">See the legal code</button>
  </div>
</div>
...
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">CC0 1.0 Universal</h3>
  ...
  <h3 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Brak praw autorskich</h3>
...
></i>
    ...
    <div class="column is-11">
      <p class=" body-big padding-bottom-normal">Osoba, która opatrzyła utwór tym oświadczeniem, <b>przekazała</b> go do domeny publicznej, zrzekając się wykonywania wszelkich praw do utworu wynikających z prawa autorskiego, włączając w to wszelkie prawa powiązane i prawa pokrewne, w zakresie dozwolonym przez prawo, na obszarze całego świata. </p>
      <p class=" body-big padding-bottom-normal">Możesz zwielokratniać, zmieniać, rozpowszechniać i wykonywac utwór, nawet w celu komercyjnym bez pytania o zgodę. Zobacz <b>inne informacje</b> poniżej.</p>
    </div>
  </div>

    
    
  <h3 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Inne informacje</h3>
  <div class="columns is-multiline">
    ...
    <div class="column is-11">
      <ul>
        ...
        <li><p class=" body-big padding-bottom-normal">O ile nie zostało złożone wyraźne przeciwne oświadczenie, osoba, która powiązała utwór z tym oświadczeniem nie udziela żadnych gwarancji do utworu i wyłącza odpowiedzialność za wszelkie wykorzystanie utworu, w maksymalnym zakresie dozwolonym przez obowiązujące prawo.</li>
        <li><p class=" body-big padding-bottom-normal">Korzystając lub cytując utwór, nie powinieneś sugerować <a href="" class="helpLink" id="endorsement" name="endorsement">poparcia</a> autora lub przekazującego.</li>
      </ul>
    </div>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Inne prawa</h4>
  <div>
    <p>Korzystanie z utworu wolnego od ograniczeń prawa autorskiego może podlegać innym regulacjom lub ograniczeniom. Utwór lub jego wykorzystanie może podlegać ochronie danych osobowych, wizerunku, prywatności, które to prawa pozwalają ich podmiotom kontrolować w jaki sposób wykorzystywane są ich dobra osobiste - lub jeszcze innym ograniczeniom, na podstawie prawa właściwego.</p>
    <p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#When_are_publicity_rights_relevant.3F">Więcej informacji</a>.</p>
  </div>


  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Poparcie</h4>
  <div>
    <p>W niektórych jurysdykcjach, nieuprawnione sugerowanie że autor, wydawca lub ktokolwiek inny popiera wykorzystanie przez Ciebie utworu może naruszać prawo.</p>
    <p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Do_I_need_to_be_aware_of_anything_else_when_providing_attribution_or_credit.3F">Więcej informacji</a>.</p>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Cytat</h4>
  <div>
    <p>
      Skopiuj i wklej kod HTML na swoją stronę, by w prosty sposób zacytować ten utwór.
    </p>
    <p>
      <a href="https://wiki.creativecommons.org/CC0_FAQ#Do_I_have_to_attribute_the_person_who_applied_CC0_to_their_work.3F">Więcej informacji</a>
    </p>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Kim jest przekazujący?</h4>
  <div>
    <p>
...
<div id="disclaimer-info-section" class="padding-bigger has-background-info-light" >
  <h4 class="padding-bottom-normal is-vcentered b-header"><i class="info icon padding-right-normal"></i>Klauzula ograniczenia odpowiedzialności</h4>

    <p> Przystępne podsumowanie nie ma charakteru prawnego. Jest to po prostu przydatne źródło informacji o tekście prawnym CC0, zrozumiały dla nieprawnika zapis niektórych jego kluczowych postanowień. Jest on przyjaznym dla użytkownika interfejsem do tekstu prawnego CC0. Podsumowanie nie ma mocy prawnej, a jego treść nie jest częścią CC0. </p> <p> Creative Commons nie jest kancelarią prawną i nie świadczy usług prawniczych. Rozpowszechnianie, wyświetlanie, ani linkowanie do tego Podsumowania nie powoduje powstania relacji typu relacja pomiędzy klientem a prawnikiem. </p> <p> Creative Commons nie sprawdziło statusu prawno-autorskiego jakiegokolwiek utworu, do którego zastosowano CC0. CC nie udziela żadnych gwarancji co do jakiegokolwiek utworu lub jego statusu prawno-autorskiego w którymkolwiek systemie prawnym i wyłącza wszelką odpowiedzialność za wszelkie wykorzystanie jakiegokolwiek utworu, w maksymalnym stopniu dozwolonym przez prawo właściwe. </p>

    <p>Ten tekst to przystępne podsumowanie <a href="./legalcode" class="fulltext">Tekstu prawnego (pełnej jego treści)</a>.</p>
