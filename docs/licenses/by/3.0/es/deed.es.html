...
<head about="http://creativecommons.org/licenses/by/3.0/es/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by/3.0/es/deed.es" aria-current="page displayed">License Deed for CC BY 3.0 ES</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            value="ast"
            data-link="/licenses/by/3.0/es/deed.ast"
          >
            asturianu
          </option>
          ...
          <option
            ...
            value="eu"
            data-link="/licenses/by/3.0/es/deed.eu"
          >
            Basque
          </option>
          ...
          <option
            ...
            value="ca"
            data-link="/licenses/by/3.0/es/deed.ca"
          >
            català
          </option>
          ...
          <option
            ...
            selected
            value="es"
            data-link="/licenses/by/3.0/es/deed.es"
          >
            español
          </option>
          ...
          <option
            ...
            value="gl"
            data-link="/licenses/by/3.0/es/deed.gl"
          >
            galego
          </option>
          ...
          <option
            ...
            value="oci"
            data-link="/licenses/by/3.0/es/deed.oci"
          >
            Occitan
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by/3.0/es/legalcode.es">See the legal code</button>
  </div>
</div>
...
<h4 class="has-text-centered is-hidden-tablet padding-left-normal">CC BY 3.0 ES</h4>
<h2 class="margin-bottom-larger b-header is-hidden-touch">Reconocimiento 3.0 España</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Reconocimiento 3.0 España</h3>
