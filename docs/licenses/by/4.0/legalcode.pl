...
<head about=" ">
    <meta charset="utf-8">
    <title>Uznanie autorstwa 4.0 Międzynarodowa</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by/4.0/legalcode.pl" aria-current="page displayed">Legal Code for CC BY 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by/4.0/deed.pl">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Uznanie autorstwa 4.0 Międzynarodowa</a>
...
></i>
  ...
  <h1 class="b-header">Uznanie autorstwa 4.0 Międzynarodowa</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Uznanie autorstwa 4.0 Międzynarodowa</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Uznanie autorstwa 4.0 Międzynarodowa</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Uznanie autorstwa 4.0 Międzynarodowa</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Uznanie autorstwa 4.0 Międzynarodowa</h3>
      ...
      <ol type="a" class="body-big padding-left-normal">
        ...
        <li id="s6b" class="padding-left-normal padding-bottom-normal">
          ...
          <ol class="body-big padding-left-normal">
            <li id="s6b1" class="padding-left-normal padding-bottom-normal">automatycznie z data usunięcia naruszenia, jeśli nastąpiło ono w ciągu 30 dni od odkrycia naruszenia przez Licencjobiorcę; lub</li>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by/4.0/legalcode.pl.txt" class="link">View Legal Code as plain text</a></p>
</div>
