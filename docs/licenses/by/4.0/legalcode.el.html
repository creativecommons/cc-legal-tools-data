...
<head about=" ">
    <meta charset="utf-8">
    <title>Creative Commons Αναφορά 4.0</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by/4.0/legalcode.el" aria-current="page displayed">Legal Code for CC BY 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by/4.0/deed.el">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Creative Commons Αναφορά 4.0</a>
...
></i>
  ...
  <h1 class="b-header">Creative Commons Αναφορά 4.0</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Creative Commons Αναφορά 4.0</h2>
</div>
...
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Creative Commons Αναφορά 4.0</h3>
  ...
  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Creative Commons Αναφορά 4.0</h3>
...
Ασκώντας τα Αδειοδοτούμενα Δικαιώματα (τα οποία ορίζονται παρακάτω), αποδέχεσθε και συμφωνείτε να δεσμευτείτε από τους όρους και τις προϋποθέσεις αυτής της Διεθνούς Δημόσιας Άδειας (Δημόσια Άδεια) Creative Commons Αναφορά 4.0 (Creative Commons Attribution 4.0 International Public License). Στο βαθμό που αυτή η άδεια μπορεί να ερμηνευτεί ως σύμβαση, τα Αδειοδοτούμενα Δικαιώματα παραχωρούνται σε Εσάς εν είδη ανταλλάγματος ("consideration") λαμβάνοντας υπόψη την εκ μέρους Σας αποδοχή αυτών των όρων και των προϋποθέσεων και ο/η Χορηγών/-ούσα την Άδεια (Αδειοδότης/-ούσα) Σας παραχωρεί τα δικαιώματα εν είδη ανταλλάγματος ("consideration") λαμβάνοντας υπόψη τις ωφέλειες που ο/η Χορηγών/-ούσα την Άδεια (Αδειοδότης/-ούσα) αποκομίζει με το να διαθέσει το Αντικείμενο της Αδειοδότησης υπό αυτούς τους όρους και προϋποθέσεις.
    ...
    <div class="padding-bottom-larger">
      ...
      <ol type="a" class="body-big padding-left-normal">
        ...
        <li id="s6b" class="padding-left-normal padding-bottom-normal">
          ...
          Προς άρση κάθε αμφιβολίας, το εν λόγω Άρθρο <a href="#s6b">6(b)</a> δεν επηρεάζει κανένα δικαίωμα του/της Χορηγούντος/-ούσας την Άδεια (Αδειοδότη/-ούσας) να αξιώσει θεραπείες λόγω παραβιάσεών Σας της παρούσας Δημόσιας Άδειας.
        </li>
    ...
    <div class="padding-bottom-normal">
      ...
      <ol type="a" class="body-big padding-left-normal">
        ...
        <li id="s8c" class="padding-left-normal padding-bottom-normal">Κανένας όρος ή προϋπόθεση της παρούσας Δημόσιας Άδειας, δεν θα γίνει αντικείμενο παραίτησης και καμία παράλειψη συμμόρφωσης δε θα θεραπεύεται εκτός εάν συμφωνηθεί ρητώς από τον/τη Χορηγούντα/-ούσα την Άδεια (Αδειοδότη/-ούσα).</li>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by/4.0/legalcode.el.txt" class="link">View Legal Code as plain text</a></p>
</div>
