...
<head about=" ">
    <meta charset="utf-8">
    <title>Naamsvermelding 4.0 Internationaal</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by/4.0/legalcode.nl" aria-current="page displayed">Legal Code for CC BY 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by/4.0/deed.nl">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Naamsvermelding 4.0 Internationaal</a>
...
></i>
  ...
  <h1 class="b-header">Naamsvermelding 4.0 Internationaal</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Naamsvermelding 4.0 Internationaal</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Naamsvermelding 4.0 Internationaal</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Naamsvermelding 4.0 Internationaal</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Naamsvermelding 4.0 Internationaal</h3>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Naamsvermelding</strong>.</p>
          <ol type="1" class="padding-left-normal padding-vertical-normal">
            ...
            <li id="s3a2" class="padding-left-normal padding-bottom-normal">Je kunt voldoen aan de voorwaarden in Artikel <a href="#s3a1">3(a)(1)</a> op elke redelijke wijze met inachtneming van het medium, de middelen, en context waarin je het Gelicenseerde Materiaal Deelt. Het kan bijvoorbeeld redelijk zijn om aan de voorwaarden te voldoen door een URI of hyperlink te plaatsen naar een bron die de vereiste informatie bevat.</li>
              ...
              <li id="s3a3" class="padding-left-normal padding-bottom-normal">Op verzoek van de Licentiegever, ben je verplicht alle informatie vermeld in Artikel <a href="#s3a1A">3(a)(1)(A)</a> te verwijderen voor zover dit redelijkerwijs mogelijk is.</li>
              
                <li id="s3a4" class="padding-left-normal padding-bottom-small">Als Je Afgeleid Materiaal dat Je hebt geproduceerd deelt, mag de Bewerkerslicentie die Je toepast de ontvangers van het Afgeleid Materiaal niet in de weg staan om te voldoen aan deze Publieke Licentie.</li>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by/4.0/legalcode.nl.txt" class="link">View Legal Code as plain text</a></p>
</div>
