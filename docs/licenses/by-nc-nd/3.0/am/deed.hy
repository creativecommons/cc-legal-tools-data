...
<head about="http://creativecommons.org/licenses/by-nc-nd/3.0/am/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nc-nd/3.0/am/deed.hy" aria-current="page displayed">License Deed for CC BY-NC-ND 3.0 AM</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="hy"
            data-link="/licenses/by-nc-nd/3.0/am/deed.hy"
          >
            հայերեն
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-nd/3.0/am/legalcode">See the legal code</button>
  </div>
</div>
...
<h4 class="has-text-centered is-hidden-tablet padding-left-normal">CC BY-NC-ND 3.0 AM</h4>
<h2 class="margin-bottom-larger b-header is-hidden-touch">Հղում, ոչ-առևտրային օգտագործում, օգտագործում առանց վերափոխումների 3.0, Հայաստան </h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Հղում, ոչ-առևտրային օգտագործում, օգտագործում առանց վերափոխումների 3.0, Հայաստան </h3>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">NoDerivatives</span> - If you <a href="#" id="some_kinds_of_mods_popup" class="helpLink">remix, transform, or build upon</a> the material, you may not distribute the modified material.
      </p>
    </div>
