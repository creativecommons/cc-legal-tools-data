...
<head about="http://creativecommons.org/licenses/by-nc-nd/3.0/gr/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nc-nd/3.0/gr/deed.el" aria-current="page displayed">License Deed for CC BY-NC-ND 3.0 GR</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="el"
            data-link="/licenses/by-nc-nd/3.0/gr/deed.el"
          >
            Ελληνικά
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-nd/3.0/gr/legalcode">See the legal code</button>
  </div>
</div>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Αναφορά Δημιουργού</span> -
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Μη παραγόμενα </span> - Αν <a href="#" id="some_kinds_of_mods_popup" class="helpLink">αναμείξετε, τροποποιήσετε, ή δημιουργήσετε πάνω</a> στο υλικό, δε μπορείτε να διανείμετε το τροποποιημένο υλικό.
      </p>
    </div>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Δεν υπάρχουν πρόσθετοι περιορισμοί</span> - Δε μπορείτε να εφαρμόσετε νομικούς όρους ή <a href="#" id="technological_measures_popup" class="helpLink">τεχνολογικά μέτρα</a> που να περιορίζουν νομικά τους άλλους από το να κάνουν  ο,τιδήποτε επιτρέπει η άδεια.
      </p>
    </div>
  </div>
  <h3 class="b-header has-text-black padding-bottom-big padding-top-normal" style="font-weight: bold;">Σημειώσεις:</h3>
  <p class="has-text-black body-big padding-bottom-normal">
