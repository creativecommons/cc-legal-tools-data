...
<head about=" ">
    <meta charset="utf-8">
    <title> Reconocimiento – No Comercial – Sin Obras Derivadas  3.0 Guatemala</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc-nd/3.0/gt/legalcode" aria-current="page displayed">Legal Code for CC BY-NC-ND 3.0 GT</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="es"
            data-link="/licenses/by-nc-nd/3.0/gt/legalcode"
          >
            español
          </option>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-nd/3.0/gt/deed.es">See the deed</button>
    </div>
  </div>
</div>
...
></i>
  ...
  <h1 class="b-header"> Reconocimiento – No Comercial – Sin Obras Derivadas  3.0 Guatemala</h1>
</div>
...
></i>
  ...
  <h2 class="has-text-centered is-hidden-touch is-hidden-desktop-only padding-left-normal">CC BY-NC-ND 3.0 GT</h2>
  <h3 class="has-text-centered is-hidden-touch">CC BY-NC-ND 3.0 GT</h3>
  <h4 class="has-text-centered is-hidden-desktop-only is-hidden-widescreen">CC BY-NC-ND 3.0 GT</h4>
  <h2 class="b-header has-text-centered"> Reconocimiento – No Comercial – Sin Obras Derivadas  3.0 Guatemala</h2>
</div>
...
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered"> Reconocimiento – No Comercial – Sin Obras Derivadas  3.0 Guatemala</h3>
  ...
  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons  Reconocimiento – No Comercial – Sin Obras Derivadas  3.0 Guatemala</h3>

    
    
    
    <div id="deed-main-content">
 <img alt="" src="https://creativecommons.org/images/international/gt.png"/>
 <blockquote>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc-nd/3.0/gt/legalcode/index.txt" class="link">View Legal Code as plain text</a></p>
</div>
