...
<head about="http://creativecommons.org/licenses/by-nc-nd/3.0/nl/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nc-nd/3.0/nl/deed.nl" aria-current="page displayed">License Deed for CC BY-NC-ND 3.0 NL</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="nl"
            data-link="/licenses/by-nc-nd/3.0/nl/deed.nl"
          >
            Nederlands
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-nd/3.0/nl/legalcode">See the legal code</button>
  </div>
</div>
...
<h4 class="has-text-centered is-hidden-tablet padding-left-normal">CC BY-NC-ND 3.0 NL</h4>
<h2 class="margin-bottom-larger b-header is-hidden-touch">Naamsvermelding-NietCommercieel-GeenAfgeleideWerken 3.0</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Naamsvermelding-NietCommercieel-GeenAfgeleideWerken 3.0</h3>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">GeenAfgeleideWerken</span> - Je mag het veranderde materiaal niet verspreiden als je het werk hebt <a href="#" id="some_kinds_of_mods_popup" class="helpLink">geremixt, veranderd, of op het werk hebt voortgebouwd</a>.
      </p>
    </div>
