...
<head about="http://creativecommons.org/licenses/by-nc-sa/3.0/es/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nc-sa/3.0/es/deed.es" aria-current="page displayed">License Deed for CC BY-NC-SA 3.0 ES</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            value="ast"
            data-link="/licenses/by-nc-sa/3.0/es/deed.ast"
          >
            asturianu
          </option>
          ...
          <option
            ...
            value="eu"
            data-link="/licenses/by-nc-sa/3.0/es/deed.eu"
          >
            Basque
          </option>
          ...
          <option
            ...
            value="ca"
            data-link="/licenses/by-nc-sa/3.0/es/deed.ca"
          >
            català
          </option>
          ...
          <option
            ...
            selected
            value="es"
            data-link="/licenses/by-nc-sa/3.0/es/deed.es"
          >
            español
          </option>
          ...
          <option
            ...
            value="gl"
            data-link="/licenses/by-nc-sa/3.0/es/deed.gl"
          >
            galego
          </option>
          ...
          <option
            ...
            value="oci"
            data-link="/licenses/by-nc-sa/3.0/es/deed.oci"
          >
            Occitan
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-sa/3.0/es/legalcode.es">See the legal code</button>
  </div>
</div>
...
<h4 class="has-text-centered is-hidden-tablet padding-left-normal">CC BY-NC-SA 3.0 ES</h4>
<h2 class="margin-bottom-larger b-header is-hidden-touch">Reconocimiento-NoComercial-CompartirIgual 3.0 España</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Reconocimiento-NoComercial-CompartirIgual 3.0 España</h3>

  
  

  <h3 class="b-header has-text-black padding-bottom-big padding-top-normal" style="font-weight: bold;">Usted es libre de:</h3>

  
   <p class="has-text-black body-big padding-bottom-normal"><strong>Compartir</strong>  &mdash; copiar y redistribuir el material en cualquier medio o formato</p>
  

  
    
      <p class="has-text-black body-big padding-bottom-small"><strong>Adaptar</strong>  &mdash; remezclar, transformar y crear a partir del material
      </p>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">NoComercial</span> -
        No puede utilizar el material para una <a href="#" id="commercial_purposes_popup" class="helpLink">finalidad comercial</a>.
      </p>
    </div>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">CompartirIgual</span> - Si remezcla, transforma o crea a partir del material, deberá difundir sus contribuciones bajo la <a href="#" id="same_license_popup" class="helpLink"> misma licencia </ a> que el original.
      </p>
    </div>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">No hay restricciones adicionales</span> - No puede aplicar términos legales o <a href="#" id="technological_measures_popup" class="helpLink">medidas tecnológicas</a> que legalmente restrinjan realizar aquello que la licencia permite.
      </p>
    </div>
  </div>
  <h3 class="b-header has-text-black padding-bottom-big padding-top-normal" style="font-weight: bold;">Avisos:</h3>
  <p class="has-text-black body-big padding-bottom-normal">
