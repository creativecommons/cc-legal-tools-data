...
<html lang="hy" class="no-js" dir="ltr">
<head about="http://creativecommons.org/licenses/by-nc-sa/3.0/am/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nc-sa/3.0/am/deed.hy" aria-current="page displayed">License Deed for CC BY-NC-SA 3.0 AM</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="hy"
            data-link="/licenses/by-nc-sa/3.0/am/deed.hy"
          >
            հայերեն
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-sa/3.0/am/legalcode">See the legal code</button>
  </div>
</div>
...
<h4 class="has-text-centered is-hidden-tablet padding-left-normal">CC BY-NC-SA 3.0 AM</h4>
<h2 class="margin-bottom-larger b-header is-hidden-touch">Հղում, ոչ-առևտրային օգտագործում, համանման տարածում 3.0, Հայաստան </h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Հղում, ոչ-առևտրային օգտագործում, համանման տարածում 3.0, Հայաստան </h3>

  
  

  <h3 class="b-header has-text-black padding-bottom-big padding-top-normal" style="font-weight: bold;">You are free to:</h3>

  
   <p class="has-text-black body-big padding-bottom-normal"><strong>Share</strong>  &mdash; copy and redistribute the material in any medium or format</p>
  

  
    
      <p class="has-text-black body-big padding-bottom-small"><strong>Adapt</strong>  &mdash; remix, transform, and build upon the material
      </p>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Հղում</span> -
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Ոչ-առևտրային օգտագործում</span> -
        You may not use the material for <a href="#" id="commercial_purposes_popup" class="helpLink">commercial purposes</a>.
      </p>
    </div>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Համանման տարածում</span> - If you remix, transform, or build upon the material, you must distribute your contributions under the <a href="#" id="same_license_popup" class="helpLink">same license</a> as the original.
      </p>
    </div>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">No additional restrictions</span> - You may not apply legal terms or <a href="#" id="technological_measures_popup" class="helpLink">technological measures</a> that legally restrict others from doing anything the license permits.
      </p>
    </div>
  </div>
  <h3 class="b-header has-text-black padding-bottom-big padding-top-normal" style="font-weight: bold;">Notices:</h3>
  <p class="has-text-black body-big padding-bottom-normal">
