...
<head about=" ">
    <meta charset="utf-8">
    <title>Atribución/Reconocimiento-NoComercial-CompartirIgual 4.0 Internacional</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc-sa/4.0/legalcode.es" aria-current="page displayed">Legal Code for CC BY-NC-SA 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-sa/4.0/deed.es">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Atribución/Reconocimiento-NoComercial-CompartirIgual 4.0 Internacional</a>
...
></i>
  ...
  <h1 class="b-header">Atribución/Reconocimiento-NoComercial-CompartirIgual 4.0 Internacional</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Atribución/Reconocimiento-NoComercial-CompartirIgual 4.0 Internacional</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Atribución/Reconocimiento-NoComercial-CompartirIgual 4.0 Internacional</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Atribución/Reconocimiento-NoComercial-CompartirIgual 4.0 Internacional</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Atribución/Reconocimiento-NoComercial-CompartirIgual 4.0 Internacional</h3>
      ...
      <ol type="a" class="body-big padding-left-normal">
          ...
          <li id="s1f_exceptions_and_limitations" class="padding-bottom-normal">
            ...
            <li id="s1g_license_elements_nc_sa" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Los </span> <strong>Elementos de la Licencia </strong> son los atributos que figuran en el nombre de la Licencia Pública de Creative Commons. Los Elementos de la Licencia de esta Licencia Pública son Atribución/Reconocimiento, NoComercial y CompartirIgual.</div>
            </li>
    ...
    <div class="padding-bottom-larger">
      ...
      <ol type="a" class="body-big padding-left-normal">
          <li id="s4a" class="padding-left-normal padding-bottom-normal">
            ...
            para evitar cualquier duda, la sección <a href="#s2a1">2(a)(1)</a> le concede a Usted el derecho a extraer, reutilizar, reproducir y Compartir todo o una parte sustancial de los contenidos de la base de datos solamente para fines NoComerciales;
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc-sa/4.0/legalcode.es.txt" class="link">View Legal Code as plain text</a></p>
</div>
