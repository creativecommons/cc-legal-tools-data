...
<head about=" ">
    <meta charset="utf-8">
    <title>Creative Commons Αναφορά-Μη Εμπορική Χρήση-Παρόμοια Διανομή
4.0</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc-sa/4.0/legalcode.el" aria-current="page displayed">Legal Code for CC BY-NC-SA 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-sa/4.0/deed.el">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Creative Commons Αναφορά-Μη Εμπορική Χρήση-Παρόμοια Διανομή
4.0</a>
...
></i>
  ...
  <h1 class="b-header">Creative Commons Αναφορά-Μη Εμπορική Χρήση-Παρόμοια Διανομή
4.0</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Creative Commons Αναφορά-Μη Εμπορική Χρήση-Παρόμοια Διανομή
4.0</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Creative Commons Αναφορά-Μη Εμπορική Χρήση-Παρόμοια Διανομή
4.0</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Creative Commons Αναφορά-Μη Εμπορική Χρήση-Παρόμοια Διανομή
4.0</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Creative Commons Αναφορά-Μη Εμπορική Χρήση-Παρόμοια Διανομή
4.0</h3>
    <p class="body-big padding-bottom-larger">
    
      Ασκώντας τα Αδειοδοτούμενα Δικαιώματα (τα οποία ορίζονται παρακάτω), αποδέχεσθε και συμφωνείτε να δεσμευτείτε από τους όρους και τις προϋποθέσεις αυτής της Διεθνούς Δημόσιας Άδειας (Δημόσια Άδεια) Creative Commons Αναφορά – Μη Εμπορική Χρήση – Παρόμοια Διανομή 4.0 (Creative Commons Attribution – NonCommercial – ShareAlike 4.0 International Public License). Στο βαθμό που αυτή η άδεια μπορεί να ερμηνευτεί ως σύμβαση, τα Αδειοδοτούμενα Δικαιώματα παραχωρούνται σε Εσάς εν είδη ανταλλάγματος ("consideration") λαμβάνοντας υπόψη την εκ μέρους Σας αποδοχή αυτών των όρων και των προϋποθέσεων και ο/η Χορηγών/-ούσα την Άδεια (Αδειοδότης/-ούσα) Σας παραχωρεί τα δικαιώματα εν είδη ανταλλάγματος ("consideration") λαμβάνοντας υπόψη τις ωφέλειες που ο/η Χορηγών/-ούσα την Άδεια (Αδειοδότης/-ούσα) αποκομίζει με το να διαθέσει το Αντικείμενο της Αδειοδότησης υπό αυτούς τους όρους και προϋποθέσεις.
      ...
      <ol type="a" class="body-big padding-left-normal">
          ...
          <li id="s1a_adapted_material" class="padding-bottom-normal">
            ...
            <li id="s1b_adapters_license" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Άδεια Διενεργούντος/-ούσας την Προσαρμογή</span> σημαίνει την άδεια που Εσείς εφαρμόζετε στα Δικαιώματα Πνευματικής Ιδιοκτησίας και σε Συγγενικά ή Παρόμοια Δικαιώματα που απολαμβάνετε επί των συμβολών Σας στο Υλικό που Προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση) σύμφωνα με τους όρους και τις προϋποθέσεις της παρούσας Δημόσιας Άδειας.</div>
            </li>
          

          
            <li id="s1c_by_nc_sa_compatible_license" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Συμβατή Άδεια Αναφορά-Μη-Εμπορική Χρήση-Παρόμοια Διανομή (ΒΥ-ΝC-SA)</span> είναι η άδεια που εντοπίζεται στον ιστότοπο <a href="//creativecommons.org/compatiblelicenses">creativecommons.org/compatiblelicenses</a>, η οποία αναγνωρίζεται από τον οργανισμό Creative Commons ως ουσιωδώς συμβατή με την παρούσα Δημόσια Άδεια.</div>
            </li>
          ...
          <li id="s1f_exceptions_and_limitations" class="padding-bottom-normal">
            ...
            <li id="s1g_license_elements_nc_sa" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Στοιχεία της Άδειας</span> σημαίνει τα βασικά χαρακτηριστικά στοιχεία της άδειας που περιλαμβάνονται στον τίτλο μίας Δημόσιας Άδειας Creative Commons. Τα Στοιχεία της Άδειας αυτής της Δημόσιας Άδειας είναι η Αναφορά, η Μη Εμπορική Χρήση και η Παρόμοια Διανομή.</div>
            </li>
          ...
          <li id="s1j_licensor" class="padding-bottom-normal">
            ...
            <li id="s1k_noncommercial" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Μη Εμπορική Χρήση</span> σημαίνει χρήση που δεν έχει ως πρωταρχικό σκοπό το εμπορικό όφελος ή χρηματικό αντάλλαγμα. Για τους σκοπούς της παρούσας Δημόσιας Άδειας, η ανταλλαγή του Αντικειμένου της Άδειας με άλλο υλικό που υπόκειται στο Δίκαιο Πνευματικής Ιδιοκτησίας και σε Συγγενικά ή Παρόμοια Δικαιώματα μέσω ψηφιακής διανομής αρχείων (file sharing) ή παρομοίων μέσων θεωρείται Μη Εμπορική Χρήση, εφόσον δεν υπάρχει καταβολή χρηματικού ανταλλάγματος για την πραγματοποίηση αυτής της ανταλλαγής.</div>
            </li>
            ...
            <div class="para">
              <ol type="A" class="padding-left-normal padding-vertical-normal">
                  ...
                  <li id="s2a5A_offer" class="padding-left-normal padding-bottom-normal"><span style="text-decoration: underline;">Προσφορά από το/τη Χορηγούντα/-ούσα την Άδεια (Αδειοδότη/-ούσα) – Αντικείμενο Αδειοδότησης</span>. Κάθε αποδέκτης του Αντικειμένου Αδειοδότησης λαμβάνει αυτόματα μια προσφορά από το/τη Χορηγούντα/-ούσα την Άδεια (Αδειοδότη/-ούσα) να ασκήσει τα Αδειοδοτούμενα Δικαιώματα σύμφωνα με τους όρους και τις προϋποθέσεις της παρούσας Δημόσιας Άδειας.</li>
                    ...
                    <li id="s2a5B_adapted_material" class="padding-left-normal padding-bottom-normal"><span style="text-decoration: underline;">Πρόσθετη πρόταση από το/τη Χορηγούντα/-ούσα την Άδεια (Αδειοδότη/-ούσα) – Υλικό που Προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση)</span>. Κάθε αποδέκτης Υλικού που Προέρχεται από Δική Σας Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση) λαμβάνει αυτόματα μια πρόταση από το/τη Χορηγούντα/-ούσα την Άδεια (Αδειοδότη/-ούσα) να ασκεί τα Αδειοδοτούμενα Δικαιώματα στο Υλικό που Προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση) σύμφωνα με τους όρους της Άδειας Προσαρμογέα που Εσείς εφαρμόζετε.</li>
                  

                  <li id="s2a5C_no_restrictions" class="padding-left-normal padding-bottom-small"><span style="text-decoration: underline;">Όχι περιορισμοί μεταγενέστερης χρήσης</span>. Δεν μπορείτε να προτείνετε ή να επιβάλετε πρόσθετους ή διαφορετικούς όρους ή προϋποθέσεις, ή να εφαρμόζετε Αποτελεσματικά Τεχνολογικά Μέτρα στο Αντικείμενο Αδειοδότησης εάν αυτό περιορίζει την άσκηση των Αδειοδοτούμενων Δικαιωμάτων σε οποιοδήποτε/οποιαδήποτε αποδέκτη του Αντικειμένου Αδειοδότησης.</li>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Αναφορά</strong>.</p>
          <ol type="1" class="padding-left-normal padding-vertical-normal">
            <li id="s3a1" class="padding-left-normal padding-bottom-normal">
              <p>Αν πραγματοποιείτε Διαμοιρασμό του Αντικειμένου της Αδειοδότησης (συμπεριλαμβανομένης της τροποποιημένης μορφής), Εσείς είστε υποχρεωμένοι/-ες:</p>
              <ol type="A" class="padding-left-normal padding-vertical-normal">
          ...
          <li id="s3b" class="padding-left-normal padding-bottom-normal"><strong>Παρόμοια Διανομή</strong>.
            <p class="padding-top-normal padding-bottom-normal">Επιπλέον των προϋποθέσεων του Άρθρου <a href="#s3a">3(a)</a>, αν πραγματοποιείτε Διμοιρασμό Υλικού που Προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση) που Εσείς έχετε παράξει, εφαρμόζονται επίσης οι εξής προϋποθέσεις.</p>
            <ol class="padding-left-normal">
              ...
              <li id="s3b2" class="padding-left-normal padding-bottom-normal">Είστε υποχρεωμένοι να συμπεριλάβετε το κείμενο, ή το Κανονιστικό Αναγνωριστικό Πόρου (URI) ή τον υπερσύνδεσμο της Άδειας Προσαρμογέα που εφαρμόζετε. Μπορείτε να ικανοποιήσετε αυτή την προϋπόθεση με οποιονδήποτε εύλογο τρόπο βάσει του μέσου, του τρόπου και του πλαισίου εντός του οποίου Εσείς πραγματοποιείτε Διαμοιρασμό του Υλικού που Προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση).</li>
              <li id="s3b3" class="padding-left-normal padding-bottom-small">Δεν μπορείτε να προτείνετε ή να επιβάλετε οποιουσδήποτε επιπρόσθετους ή διαφορετικούς όρους ή προϋποθέσεις, ή να εφαρμόσετε οποιαδήποτε Αποτελεσματικά Τεχνολογικά Μέτρα στο Υλικό που Προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση), τα οποία περιορίζουν την άσκηση των εξουσιών που χορηγούνται βάσει της Άδειας του Διενεργούντος/-ούσας την Προσαρμογή που εφαρμόζετε.</li>
            </ol>
          </li>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc-sa/4.0/legalcode.el.txt" class="link">View Legal Code as plain text</a></p>
</div>
