...
<head about=" ">
    <meta charset="utf-8">
    <title>Uznanie autorstwa - Użycie niekomercyjne - Na tych samych
warunkach 4.0 Międzynarodowa</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc-sa/4.0/legalcode.pl" aria-current="page displayed">Legal Code for CC BY-NC-SA 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-sa/4.0/deed.pl">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Uznanie autorstwa - Użycie niekomercyjne - Na tych samych
warunkach 4.0 Międzynarodowa</a>
...
></i>
  ...
  <h1 class="b-header">Uznanie autorstwa - Użycie niekomercyjne - Na tych samych
warunkach 4.0 Międzynarodowa</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Uznanie autorstwa - Użycie niekomercyjne - Na tych samych
warunkach 4.0 Międzynarodowa</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Uznanie autorstwa - Użycie niekomercyjne - Na tych samych
warunkach 4.0 Międzynarodowa</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Uznanie autorstwa - Użycie niekomercyjne - Na tych samych
warunkach 4.0 Międzynarodowa</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Uznanie autorstwa - Użycie niekomercyjne - Na tych samych
warunkach 4.0 Międzynarodowa</h3>
      ...
      <ol type="a" class="body-big padding-left-normal">
          ...
          <li id="s1f_exceptions_and_limitations" class="padding-bottom-normal">
            ...
            <li id="s1g_license_elements_nc_sa" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Elementy Licencji</span> oznaczają atrybuty wymienione w nazwie Licencji Publicznej Creative Commons. Elementami Licencji w przypadku niniejszej Licencji Publicznej jest Uznanie autorstwa, Użycie Niekomercyjne, Na tych samych warunkach.</div>
            </li>
    ...
    <div class="padding-bottom-larger">
      ...
      <ol type="a" class="body-big padding-left-normal">
          <li id="s4a" class="padding-left-normal padding-bottom-normal">
            ...
            w razie wątpliwości, Paragraf <a href="#s2a1">2(a)(1)</a> przyznaje Licencjobiorcy prawo do wyodrębniania, ponownego wykorzystania, zwielokrotniania i Dzielenia się całością lub istotną częścią bazy danych, jedynie dla celów Użycia Niekomercyjnego;
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc-sa/4.0/legalcode.pl.txt" class="link">View Legal Code as plain text</a></p>
</div>
