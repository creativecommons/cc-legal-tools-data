...
<head about=" ">
    <meta charset="utf-8">
    <title>Uveďte původ-Zachovejte licenci 4.0 Mezinárodní</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-sa/4.0/legalcode.cs" aria-current="page displayed">Legal Code for CC BY-SA 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-sa/4.0/deed.cs">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Uveďte původ-Zachovejte licenci 4.0 Mezinárodní</a>
...
></i>
  ...
  <h1 class="b-header">Uveďte původ-Zachovejte licenci 4.0 Mezinárodní</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Uveďte původ-Zachovejte licenci 4.0 Mezinárodní</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Uveďte původ-Zachovejte licenci 4.0 Mezinárodní</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Uveďte původ-Zachovejte licenci 4.0 Mezinárodní</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Uveďte původ-Zachovejte licenci 4.0 Mezinárodní</h3>
      ...
      <ol type="a" class="body-big padding-left-normal">
          ...
          <li id="s1a_adapted_material" class="padding-bottom-normal">
            ...
            <li id="s1c_by_sa_compatible_license" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Licencí kompatibilní s BY-SA</span> se rozumí licence uvedená na <a href="//creativecommons.org/compatiblelicenses"> creativecommons.org/compatiblelicenses</a>, schválená Creative Commons jako v zásadě rovnocenná s touto Veřejnou licencí.</div>
            </li>
          ...
          <li id="s1f_exceptions_and_limitations" class="padding-bottom-normal">
            ...
            <li id="s1g_license_elements_sa" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Licenčními prvky</span> se rozumí podstatné znaky licence uvedené v názvu této Veřejné licence Creative Commons. Licenční prvky této Veřejné licence jsou Uveďte původ a Zachovejte licenci.</div>
            </li>
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">Za podmínek stanovených touto Veřejnou licencí Vám Poskytovatel poskytuje celosvětovou, bezúplatnou, nevýhradní, neodvolatelnou licenci, bez možnosti udělení podlicence, k výkonu Licencovaných práv k Licencovanému obsahu tímto způsobem a v tomto rozsahu:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1A" class="padding-left-normal padding-bottom-normal">rozmnožování a Sdílení Zpracovaného obsahu jako celku nebo části; a</li>
            

            
              <li id="s2a1B" class="padding-left-normal padding-bottom-small">vytváření, rozmnožování a Sdílení Zpracovaného obsahu.</li>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Uveďte původ</strong>.</p>
          ...
          <li id="s3b" class="padding-left-normal padding-bottom-normal"><strong>Zachovejte licenci</strong>.
            ...
            <ol class="padding-left-normal">
              <li id="s3b1" class="padding-left-normal padding-bottom-normal">Licence zpracovatele, kterou poskytujete, musí být licence Creative Commons se stejnými Licenčními prvky, a to tato nebo novější verze, nebo Licence kompatibilní s BY-SA.</li>
    ...
    <div class="padding-bottom-larger">
      ...
      <ol type="a" class="body-big padding-left-normal">
          <li id="s4a" class="padding-left-normal padding-bottom-normal">
            ...
            pro vyloučení pochybností, článek <a href="#s2a1">2(a)(1)</a> Vás opravňuje vytěžovat, zužitkovávat, rozmnožovat a Sdílet celý obsah databáze nebo podstatnou část obsahu databáze;
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-sa/4.0/legalcode.cs.txt" class="link">View Legal Code as plain text</a></p>
</div>
