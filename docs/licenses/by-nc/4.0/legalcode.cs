...
<head about=" ">
    <meta charset="utf-8">
    <title>Uveďte původ-Neužívejte komerčně 4.0 Mezinárodní</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc/4.0/legalcode.cs" aria-current="page displayed">Legal Code for CC BY-NC 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc/4.0/deed.cs">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Uveďte původ-Neužívejte komerčně 4.0 Mezinárodní</a>
...
></i>
  ...
  <h1 class="b-header">Uveďte původ-Neužívejte komerčně 4.0 Mezinárodní</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Uveďte původ-Neužívejte komerčně 4.0 Mezinárodní</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Uveďte původ-Neužívejte komerčně 4.0 Mezinárodní</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Uveďte původ-Neužívejte komerčně 4.0 Mezinárodní</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Uveďte původ-Neužívejte komerčně 4.0 Mezinárodní</h3>
    <p class="body-big padding-bottom-larger">
    
      Výkonem Licencovaných práv (jak jsou definována níže) souhlasíte s licenčními podmínkami Creative Commons Uveďte původ-Neužívejte komerčně 4.0 Mezinárodní veřejná licence (dále jen „Veřejná licence“) a zavazujete se je dodržovat. V rozsahu, v jakém lze tuto Veřejnou licenci chápat jako smlouvu, je Vám oprávnění vykonávat Licencovaná práva uděleno jako protiplnění za Váš souhlas s těmito licenčními podmínkami. Poskytovatel Vám toto oprávnění poskytuje jako protiplnění za výhody, které pro něj vyplývají z toho, že je Licencovaný obsah zpřístupňován za těchto licenčních podmínek.
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">Za podmínek stanovených touto Veřejnou licencí Vám Poskytovatel poskytuje celosvětovou, bezúplatnou, nevýhradní, neodvolatelnou licenci, bez možnosti udělení podlicence, k výkonu Licencovaných práv k Licencovanému obsahu tímto způsobem a v tomto rozsahu:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1A" class="padding-left-normal padding-bottom-normal">rozmnožování a Sdílení Licencovaného obsahu jako celku nebo jeho části, a to pouze pro Nekomerční účely; a</li>
            

            
              <li id="s2a1B" class="padding-left-normal padding-bottom-small">vytváření, rozmnožování a Sdílení Zpracovaného obsahu pouze pro Nekomerční účely.</li>
          ...
          <li id="s2a5" class="padding-left-normal padding-bottom-small">
            ...
            <div class="para">
              <ol type="A" class="padding-left-normal padding-vertical-normal">
                  ...
                  <li id="s2a5B_no_restrictions" class="padding-left-normal padding-bottom-small"><span style="text-decoration: underline;">Žádná další omezení</span>. Licencovaný obsah nesmíte nabízet za dalších či jiných podmínek, ani na něj uplatňovat Účinné technické prostředky, pokud by to omezovalo vykonávání Licencovaných práv jakýmkoli příjemcem Licencovaného obsahu.</li>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Uveďte původ</strong>.</p>
          <ol type="1" class="padding-left-normal padding-vertical-normal">
            ...
            <li id="s3a2" class="padding-left-normal padding-bottom-normal">V závislosti na médiu, způsobu a kontextu ve kterém Licencovaný obsah sdílíte, můžete podmínky stanovené v článku <a href="#s3a1">3(a)(1)</a> splnit jakýmkoli přiměřeným způsobem. Za přiměřené lze například považovat splnění podmínek tím, že je uvedeno URI nebo hypertextový odkaz na zdroj, který obsahuje požadované informace.</li>
              ...
              <li id="s3a3" class="padding-left-normal padding-bottom-normal">Pokud to Poskytovatel požaduje, musíte odstranit jakékoli informace požadované dle článku <a href="#s3a1A">3(a)(1)(A)</a> v rozumně proveditelném rozsahu.</li>
              
                <li id="s3a4" class="padding-left-normal padding-bottom-small">Pokud Sdílíte Zpracovaný obsah, který jste vytvořili, nesmí Licence zpracovatele zabraňovat příjemcům Zpracovaného obsahu dodržovat tuto Veřejnou licenci.</li>
    ...
    <div class="padding-bottom-larger">
      ...
      <ol type="a" class="body-big padding-left-normal">
          ...
          <li id="s4b" class="padding-left-normal padding-bottom-normal">
              ...
              pokud zahrnete celý obsah databáze nebo jeho podstatnou část do databáze, ke které Vám náleží Zvláštní práva pořizovatele databáze, potom je tato databáze (ovšem nikoli její jednotlivé prvky), ke které Vám náleží Zvláštní práva pořizovatele databáze, Zpracovaný obsah; a
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc/4.0/legalcode.cs.txt" class="link">View Legal Code as plain text</a></p>
</div>
