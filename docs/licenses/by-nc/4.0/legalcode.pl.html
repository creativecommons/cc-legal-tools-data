...
<head about=" ">
    <meta charset="utf-8">
    <title>Uznanie autorstwa - Użycie niekomercyjne 4.0
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc/4.0/legalcode.pl" aria-current="page displayed">Legal Code for CC BY-NC 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc/4.0/deed.pl">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Uznanie autorstwa - Użycie niekomercyjne 4.0
Międzynarodowa</a>
...
></i>
  ...
  <h1 class="b-header">Uznanie autorstwa - Użycie niekomercyjne 4.0
Międzynarodowa</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Uznanie autorstwa - Użycie niekomercyjne 4.0
Międzynarodowa</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Uznanie autorstwa - Użycie niekomercyjne 4.0
Międzynarodowa</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Uznanie autorstwa - Użycie niekomercyjne 4.0
Międzynarodowa</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Uznanie autorstwa - Użycie niekomercyjne 4.0
Międzynarodowa</h3>
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">Zgodnie z postanowieniami niniejszej Licencji Publicznej, Licencjodawca udziela niniejszym Licencjobiorcy, nieodpłatnej, nieobejmującej prawa do udzielania sublicencji, niewyłącznej, nieodwołalnej licencji na korzystanie z Utworu na terytorium całego świata w odniesieniu Utworu Licencjonowanego Uprawnień Licencyjnych do:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1A" class="padding-left-normal padding-bottom-normal">zwielokrotniania i Dzielenia się Utworem Licencjonowanym, w całości lub w części, wyłącznie dla celów Użycia Niekomercyjnego; i</li>
            

            
              <li id="s2a1B" class="padding-left-normal padding-bottom-small">tworzenia, zwielokrotniania i Dzielenia się Utworem Zależnym wyłącznie dla celów Użycia Niekomercyjnego.</li>
          ...
          <li id="s2a5" class="padding-left-normal padding-bottom-small">
            ...
            <div class="para">
              <ol type="A" class="padding-left-normal padding-vertical-normal">
                  ...
                  <li id="s2a5B_no_restrictions" class="padding-left-normal padding-bottom-small"><span style="text-decoration: underline;">Żadnych ograniczeń dla dalszych odbiorców</span>. Licencjobiorca nie może oferować ani nakładać dodatkowych lub zmienionych warunków wykorzystania Utworu Licencjonowanego, ani stosować jakichkolwiek Skutecznych Zabezpieczeń Technicznych, jeśli działania te ograniczają wykonywanie Uprawnień Licencyjnych przez jakiegokolwiek odbiorcę Utworu Licencjonowanego.</li>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Uznanie autorstwa</strong>.</p>
          <ol type="1" class="padding-left-normal padding-vertical-normal">
            ...
            <li id="s3a2" class="padding-left-normal padding-bottom-normal">Warunków określonych w Paragrafie <a href="#s3a1">3(a)(1)</a> Licencjobiorca może dochować w każdy rozsądny sposób, stosownie do nośnika, środka przekazu i kontekstu, w jakim Licencjobiorca Dzieli się Utworem Licencjonowanym. Na przykład, rozsądnym dochowaniem wyżej określonych warunków może być załączenie adresu URI lub hiperłącza do źródła zawierającego wymagane informacje.</li>
              ...
              <li id="s3a3" class="padding-left-normal padding-bottom-normal">Jeśli zażąda tego Licencjodawca, Licencjobiorca obowiązany jest usunąć wszelkie informacje określone w Paragrafie <a href="#s3a1A">3(a)(1)(A)</a> w uzasadnionym zakresie wyznaczonym przez możliwości techniczne.</li>
              
                <li id="s3a4" class="padding-left-normal padding-bottom-small">Jeśli Licencjobiorca Dzieli się stworzonymi przez siebie Utworami Zależnymi, Licencja Twórcy Utworu Zależnego nie może ograniczać użytkowników Utworu Zależnego w dochowaniu warunków niniejszej Licencji Publicznej.</li>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc/4.0/legalcode.pl.txt" class="link">View Legal Code as plain text</a></p>
</div>
