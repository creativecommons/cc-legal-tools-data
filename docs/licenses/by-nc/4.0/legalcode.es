...
<head about=" ">
    <meta charset="utf-8">
    <title>Atribución/Reconocimiento-NoComercial 4.0 Internacional</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc/4.0/legalcode.es" aria-current="page displayed">Legal Code for CC BY-NC 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc/4.0/deed.es">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Atribución/Reconocimiento-NoComercial 4.0 Internacional</a>
...
></i>
  ...
  <h1 class="b-header">Atribución/Reconocimiento-NoComercial 4.0 Internacional</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Atribución/Reconocimiento-NoComercial 4.0 Internacional</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Atribución/Reconocimiento-NoComercial 4.0 Internacional</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Atribución/Reconocimiento-NoComercial 4.0 Internacional</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Atribución/Reconocimiento-NoComercial 4.0 Internacional</h3>
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">Sujeto a los términos y condiciones de esta Licencia Pública, el Licenciante le otorga a Usted una licencia de carácter global, gratuita, no transferible a terceros, no exclusiva e irrevocable para ejercer los Derechos Licenciados sobre el Material Licenciado para:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1A" class="padding-left-normal padding-bottom-normal">reproducir y Compartir el Material Licenciado, en su totalidad o en parte, solamente para fines NoComerciales; y</li>
            

            
              <li id="s2a1B" class="padding-left-normal padding-bottom-small">producir, reproducir y Compartir Material Adaptado solamente para fines NoComerciales.</li>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Atribución/Reconocimiento</strong>.</p>
          <ol type="1" class="padding-left-normal padding-vertical-normal">
            ...
            <li id="s3a2" class="padding-left-normal padding-bottom-normal">Usted puede satisfacer las condiciones de la sección <a href="#s3a1">3(a)(1)</a> de cualquier forma razonable según el medio, las maneras y el contexto en los cuales Usted Comparta el Material Licenciado. Por ejemplo, puede ser razonable satisfacer las condiciones facilitando un URI o un hipervínculo a un recurso que incluya la información requerida.</li>
              ...
              <li id="s3a3" class="padding-left-normal padding-bottom-normal">Bajo requerimiento del Licenciante, Usted debe eliminar cualquier información requerida por la sección <a href="#s3a1A">3(a)(1)(A)</a> en la medida razonablemente posible.</li>
              
                <li id="s3a4" class="padding-left-normal padding-bottom-small">Si Usted Comparte Material Adaptado producido por Usted, la Licencia del Adaptador que Usted aplique no debe evitar que los destinatarios del material adaptado cumplan con esta Licencia Pública.</li>
    ...
    <div class="padding-bottom-larger">
      ...
      <ol type="a" class="body-big padding-left-normal">
        ...
        <li id="s6b" class="padding-left-normal padding-bottom-normal">
          <p class="body-big padding-bottom-normal">En aquellos casos en que Su derecho a utilizar el Material Licenciado se haya terminado conforme a la sección 6(a), éste será restablecido:</p>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc/4.0/legalcode.es.txt" class="link">View Legal Code as plain text</a></p>
</div>
