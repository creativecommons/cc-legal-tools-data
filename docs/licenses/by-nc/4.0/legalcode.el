...
<head about=" ">
    <meta charset="utf-8">
    <title>Creative Commons Αναφορά-Μη Εμπορική Χρήση 4.0</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc/4.0/legalcode.el" aria-current="page displayed">Legal Code for CC BY-NC 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc/4.0/deed.el">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Creative Commons Αναφορά-Μη Εμπορική Χρήση 4.0</a>
...
></i>
  ...
  <h1 class="b-header">Creative Commons Αναφορά-Μη Εμπορική Χρήση 4.0</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Creative Commons Αναφορά-Μη Εμπορική Χρήση 4.0</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Creative Commons Αναφορά-Μη Εμπορική Χρήση 4.0</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Creative Commons Αναφορά-Μη Εμπορική Χρήση 4.0</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Creative Commons Αναφορά-Μη Εμπορική Χρήση 4.0</h3>
    <p class="body-big padding-bottom-larger">
    
      Ασκώντας τα Αδειοδοτούμενα Δικαιώματα (τα οποία ορίζονται παρακάτω), αποδέχεσθε και συμφωνείτε να δεσμευτείτε από τους όρους και τις προϋποθέσεις αυτής της Διεθνούς Δημόσιας Άδειας (Δημόσια Άδεια) Creative Commons Αναφορά – Μη Εμπορική Χρήση 4.0 (Creative Commons Attribution – NonCommercial 4.0 International Public License). Στο βαθμό που αυτή η άδεια μπορεί να ερμηνευτεί ως σύμβαση, τα Αδειοδοτούμενα Δικαιώματα παραχωρούνται σε Εσάς εν είδη ανταλλάγματος ("consideration") λαμβάνοντας υπόψη την εκ μέρους Σας αποδοχή αυτών των όρων και των προϋποθέσεων και ο/η Χορηγών/-ούσα την Άδεια (Αδειοδότης/-ούσα) Σας παραχωρεί τα δικαιώματα εν είδη ανταλλάγματος ("consideration") λαμβάνοντας υπόψη τις ωφέλειες που ο/η Χορηγών/-ούσα την Άδεια (Αδειοδότης/-ούσα) αποκομίζει με το να διαθέσει το Αντικείμενο της Αδειοδότησης υπό αυτούς τους όρους και προϋποθέσεις.
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">Σύμφωνα με τους όρους και τις προϋποθέσεις της παρούσας Δημόσιας Άδειας, ο/η Χορηγών/-ούσα την Άδεια (Αδειοδότης/-ούσα) αποφασίζει να Σας παρέχει εφεξής μια παγκόσμια, άνευ αμοιβής, χωρίς δικαίωμα υποαδειοδότησης, μη αποκλειστική, μη ανακλητή άδεια για άσκηση των Αδειοδοτούμενων Δικαιωμάτων στο Αντικείμενο της Αδειοδότησης ώστε:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1A" class="padding-left-normal padding-bottom-normal">να αναπαράγετε και να πραγματοποιείτε Διαμοιρασμό του Αντικειμένου της Αδειοδότησης, εν όλω ή εν μέρει, μόνο για σκοπούς Μη Εμπορικής Χρήσης, και</li>
            

            
              <li id="s2a1B" class="padding-left-normal padding-bottom-small">να παράγετε, να αναπαράγετε, και να πραγματοποιείτε Διαμοιρασμό του Υλικού που Προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση) μόνο για σκοπούς Μη Εμπορικής Χρήσης.</li>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Αναφορά</strong>.</p>
          <ol type="1" class="padding-left-normal padding-vertical-normal">
            ...
            <li id="s3a2" class="padding-left-normal padding-bottom-normal">Μπορείτε να ικανοποιήσετε τις προϋποθέσεις του Άρθρου <a href="#s3a1">3(a)(1)</a> με οποιονδήποτε εύλογο τρόπο βάσει του μέσου, του τρόπου και του πλαισίου με τα οποία Εσείς πραγματοποιήσατε Διαμοιρασμό του Αντικειμένου Αδειοδότησης. Για παράδειγμα, μπορεί να είναι εύλογο να ικανοποιήσετε τις προϋποθέσεις παρέχοντας ένα Κανονιστικό Αναγνωριστικό Πόρου (URI) ή έναν υπερσύνδεσμο σε μια πηγή που περιλαμβάνει τις απαιτούμενες πληροφορίες.</li>
              ...
              <li id="s3a3" class="padding-left-normal padding-bottom-normal">Αν ζητηθεί από το/τη Χορηγούντα/-ούσα την Άδεια (Αδειοδότη/-ούσα), είστε υποχρεωμένοι/-ες να αφαιρέσετε οποιαδήποτε πληροφορία που απαιτείται από το Άρθρο <a href="#s3a1A">3(a)(1)(A)</a> στο βαθμό που αυτό είναι δυνατόν.</li>
              
                <li id="s3a4" class="padding-left-normal padding-bottom-small">Aν πραγματοποιείτε Διαμοιρασμό του Υλικού που Προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση) που Εσείς έχετε πραγματοποιήσει, η Άδεια του Διενεργούντος/-ούσας την Προσαρμογή που εφαρμόζετε δεν πρέπει να εμποδίζει αποδέκτες του Υλικού που προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση) από το να συμμορφώνονται με την παρούσα Δημόσια Άδεια.</li>
    ...
    <div class="padding-bottom-larger">
      ...
      <ol type="a" class="body-big padding-left-normal">
        ...
        <li id="s6b" class="padding-left-normal padding-bottom-normal">
          ...
          Προς άρση κάθε αμφιβολίας, το εν λόγω Άρθρο <a href="#s6b">6(b)</a> δεν επηρεάζει κανένα δικαίωμα του/της Χορηγούντος/-ούσαςς την Άδεια (Αδειοδότη/-ούσα) να αξιώσει θεραπείες λόγω παραβιάσεών Σας της παρούσας Δημόσιας Άδειας.
        </li>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc/4.0/legalcode.el.txt" class="link">View Legal Code as plain text</a></p>
</div>
