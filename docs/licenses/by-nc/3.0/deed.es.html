...
<html dir="ltr" lang="es">
  <head about="https://creativecommons.org/licenses/by-nc/3.0/">
    ...
    <title>
      Deed - Atribución-NoComercial 3.0 No portada - Creative Commons
    </title>
    <link
      href="https://creativecommons.org/licenses/by-nc/3.0/deed.es"
      rel="canonical"
    />
    <!-- Default: English -->
    <link
  ...
  >
    ...
    <main>
      <header>
        <h1>Atribución-NoComercial 3.0 No portada</h1>
      ...
      <div class="content">
        <div class="notice-top" id="notice-newer-license">
          ...
          <p>
            ...
            <a href="../4.0/deed.es"
              >Deed - Atribución/Reconocimiento-NoComercial 4.0 Internacional</a
            >
          </p>
        </div>
        <div class="tool-meta">
