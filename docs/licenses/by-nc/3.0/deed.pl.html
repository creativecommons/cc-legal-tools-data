...
<html dir="ltr" lang="pl">
  <head about="https://creativecommons.org/licenses/by-nc/3.0/">
    ...
    <title>
      Deed - Uznanie autorstwa-Użycie niekomercyjne 3.0 Unported - Creative
      Commons
    </title>
    <link
      href="https://creativecommons.org/licenses/by-nc/3.0/deed.pl"
      rel="canonical"
    />
    <!-- Default: English -->
    <link
  ...
  >
    ...
    <main>
      <header>
        <h1>Uznanie autorstwa-Użycie niekomercyjne 3.0 Unported</h1>
      ...
      <div class="content">
        <div class="notice-top" id="notice-newer-license">
          ...
          <p>
            ...
            <a href="../4.0/deed.pl"
              >Deed - Uznanie autorstwa - Użycie niekomercyjne 4.0
              Międzynarodowa</a
            >
          </p>
        </div>
        ...
        <div id="deed-body">
          ...
          <ol>
            ...
            <li class="cc-nc">
              <strong>Użycie niekomercyjne</strong> — Nie należy wykorzystywać
              utworu do
              <a href="#ref-commercial-purposes" id="src-commercial-purposes"
                >celów komercyjnych</a
              >
            </li>
            <li>
            ...
            <ul>
              ...
              <li>
                <article class="note" id="ref-commercial-purposes">
                  ...
                  <strong>celów komercyjnych</strong> — Przez użycie komercyjne
                  rozumiemy takie, które służy przede wszystkim uzyskaniu
                  korzyści majątkowej lub pieniężnego wynagrodzenia.
                  <ul>
                    <li>
                      <a
