...
<head about=" ">
    <meta charset="utf-8">
    <title>С указанием авторства-Без производных версии 4.0 Международная</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nd/4.0/legalcode.ru" aria-current="page displayed">Legal Code for CC BY-ND 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nd/4.0/deed.ru">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">С указанием авторства-Без производных версии 4.0 Международная</a>
...
></i>
  ...
  <h1 class="b-header">С указанием авторства-Без производных версии 4.0 Международная</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">С указанием авторства-Без производных версии 4.0 Международная</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">С указанием авторства-Без производных версии 4.0 Международная</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">С указанием авторства-Без производных версии 4.0 Международная</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons С указанием авторства-Без производных версии 4.0 Международная</h3>
    <p class="body-big padding-bottom-larger">
    
    Осуществляя Лицензируемые права (как указано ниже), Вы принимаете и соглашаетесь соблюдать условия настоящей Публичной лицензии Creative Commons С указанием авторства-Без производных версии 4.0 Международная (далее - "Публичная Лицензия"). В том объеме, в котором настоящая Публичная Лицензия может считаться договором, Вам предоставляются Лицензируемые права в качестве встречного предоставления за принятие Вами условий такого договора. Лицензиар предоставляет Вам такие права с учетом благ, которые Лицензиар получает от предоставления доступа к Лицензируемому Материалу на указанных условиях.
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nd/4.0/legalcode.ru.txt" class="link">View Legal Code as plain text</a></p>
</div>
