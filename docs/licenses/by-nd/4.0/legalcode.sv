...
<head about=" ">
    <meta charset="utf-8">
    <title>Erkännande-IngaBearbetningar 4.0 Internationell</title>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nd/4.0/legalcode.sv.txt" class="link">View Legal Code as plain text</a></p>
</div>
