...
<head about="http://creativecommons.org/licenses/by-nd/3.0/am/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nd/3.0/am/deed.hy" aria-current="page displayed">License Deed for CC BY-ND 3.0 AM</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="hy"
            data-link="/licenses/by-nd/3.0/am/deed.hy"
          >
            հայերեն
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nd/3.0/am/legalcode">See the legal code</button>
  </div>
</div>
