...
associated with the licenses and public domain declarations (static HTML,
internationalization and localization files, etc.). It includes data consumed
and generated by the [creativecommons/cc-legal-tools][cc-legal-tools]
application.
...
[cc-legal-tools]: https://github.com/creativecommons/cc-legal-tools
...
[creativecommons/cc-legal-tools][cc-legal-tools] and output from it. See that
...
- **[`docs/`](docs)**
  - ***(:warning: NOT YET ACTIVE)*** CC Licenses data served by
    **[creativecommons.org/licenses](https://creativecommons.org/licenses)**
    website
  - *generated* by [cc-legal-tools][cc-legal-tools] `publish` command
- **[`legacy/`](legacy)**
  - **[`legalcode/`](legacy/legalcode)**
    - Legacy legalcode (HTML and some plaintext)
    - *ingested* by [cc-legal-tools][cc-legal-tools] `load_html_files` command
  - **[`rdf-licenses/`](legacy/rdf-licenses)**
    - Legacy RDF files for legalcode
    - *ingested* by [cc-legal-tools][cc-legal-tools] `publish` command
...
- Gettext Files details:
  - `.mo` machine object Gettext Files
    - *generated* by [cc-legal-tools][cc-legal-tools] `compilemessages` and
      `load_html_files` commands
    - *ingested* by [cc-legal-tools][cc-legal-tools] `publish` and `runserver`
      commands
  - `.po` portable object Gettext Files
    - *generated* by [cc-legal-tools][cc-legal-tools]
      `check_for_translation_updates` command
    - *ingested* by [cc-legal-tools][cc-legal-tools] `compilemessages` and
      `runserver` commands
...
[cc-legal-tools][cc-legal-tools] application that ingests/generates it.
...
[settings-base]: https://github.com/creativecommons/cc-legal-tools/blob/main/cc_licenses/settings/base.py
...
- Additional codes are defined by the [cc-legal-tools][cc-legal-tools]
