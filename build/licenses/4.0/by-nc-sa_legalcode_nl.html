...
<head about=" ">
    <meta charset="utf-8">
    <title>Naamsvermelding-NietCommercieel-GelijkDelen 4.0 Internationaal</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc-sa/4.0/legalcode.nl" aria-current="page displayed">Legal Code for CC BY-NC-SA 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-sa/4.0/deed.nl">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Naamsvermelding-NietCommercieel-GelijkDelen 4.0 Internationaal</a>
...
></i>
  ...
  <h1 class="b-header">Naamsvermelding-NietCommercieel-GelijkDelen 4.0 Internationaal</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Naamsvermelding-NietCommercieel-GelijkDelen 4.0 Internationaal</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Naamsvermelding-NietCommercieel-GelijkDelen 4.0 Internationaal</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Naamsvermelding-NietCommercieel-GelijkDelen 4.0 Internationaal</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Naamsvermelding-NietCommercieel-GelijkDelen 4.0 Internationaal</h3>
    <p class="body-big padding-bottom-larger">
    
      Door het uitoefenen van de door de licentie verleende rechten (zoals hieronder omschreven), ga Je akkoord met de voorwaarden en condities van deze Creative Commons Naamsvermelding-NietCommercieel-GelijkDelen 4.0 Internationale Publieke Licentie (“Publieke Licentie”). Voor zover deze Publieke Licentie geïnterpreteerd kan worden als een contract, worden Jou de gelicenseerde rechten verleend met inachtneming van Jouw aanvaarding van deze voorwaarden en condities, en de Licentiegever verleent Jou deze rechten met inachtneming van de voordelen die de Licentiegever ontvangt door het beschikbaar stellen van het Gelicenseerde Materiaal onder deze voorwaarden en condities.
      ...
      <ol type="a" class="body-big padding-left-normal">
          ...
          <li id="s1f_exceptions_and_limitations" class="padding-bottom-normal">
            ...
            <li id="s1g_license_elements_nc_sa" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Licentie-elementen</span> betekent de licentie-eigenschappen die vermeld worden in de naam van een Creative Commons Publieke Licentie. De Licentie-elementen van deze Publieke Licentie zijn Naamsvermelding, NietCommercieel en GelijkDelen.</div>
            </li>
          ...
          <li id="s2a5" class="padding-left-normal padding-bottom-small">
            ...
            <div class="para">
              <ol type="A" class="padding-left-normal padding-vertical-normal">
                  ...
                  <li id="s2a5C_no_restrictions" class="padding-left-normal padding-bottom-small"><span style="text-decoration: underline;">Geen verdere beperkingen</span>. Je mag geen aanvullende of afwijkende voorwaarden of conditie aanbieden of opleggen, noch enige Doeltreffende Technologische Maatregelen toepassen, als daardoor de uitoefening van de Gelicenseerde Rechten door de ontvanger van het Gelicenseerde Materiaal wordt beperkt.</li>
    ...
    <div class="padding-bottom-larger">
      ...
      <ol type="a" class="body-big padding-left-normal">
          <li id="s4a" class="padding-left-normal padding-bottom-normal">
            ...
            Om twijfel te voorkomen: Artikel <a href="#s2a1">2(a)(1)</a> verleent Jou het recht om op te vragen, hergebruiken, te reproduceren en te Delen van alle, of een substantieel deel van de, inhoud van de databank uitsluitend voor NietCommerciële doeleinden;
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc-sa/4.0/legalcode.nl.txt" class="link">View Legal Code as plain text</a></p>
</div>
