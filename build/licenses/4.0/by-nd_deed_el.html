...
<li class="is-active"><a href="/licenses/by-nd/4.0/deed.el" aria-current="page displayed">License Deed for CC BY-ND 4.0</a></li>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nd/4.0/legalcode.el">See the legal code</button>
  </div>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Creative Commons Αναφορά-Όχι Παράγωγα Έργα 4.0</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Creative Commons Αναφορά-Όχι Παράγωγα Έργα 4.0</h3>
