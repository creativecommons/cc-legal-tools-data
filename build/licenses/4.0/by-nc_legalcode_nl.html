...
<head about=" ">
    <meta charset="utf-8">
    <title>Naamsvermelding-NietCommercieel 4.0 Internationaal</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc/4.0/legalcode.nl" aria-current="page displayed">Legal Code for CC BY-NC 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc/4.0/deed.nl">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Naamsvermelding-NietCommercieel 4.0 Internationaal</a>
...
></i>
  ...
  <h1 class="b-header">Naamsvermelding-NietCommercieel 4.0 Internationaal</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Naamsvermelding-NietCommercieel 4.0 Internationaal</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Naamsvermelding-NietCommercieel 4.0 Internationaal</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Naamsvermelding-NietCommercieel 4.0 Internationaal</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Naamsvermelding-NietCommercieel 4.0 Internationaal</h3>
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">Met inachtneming van de voorwaarden en condities van deze Publieke Licentie verleent de Licentiegever hierbij aan Jou een wereldwijde, royalty-vrije, niet in sublicentie te geven, niet-exclusieve, onherroepelijke licentie om de Gelicenseerde Rechten met betrekking tot het Gelicenseerde Materiaal uit te oefenen:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1B" class="padding-left-normal padding-bottom-small">het produceren, reproduceren, en Delen van Afgeleid Materiaal alleen voor NietCommerciële doeleinden.</li>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc/4.0/legalcode.nl.txt" class="link">View Legal Code as plain text</a></p>
</div>
