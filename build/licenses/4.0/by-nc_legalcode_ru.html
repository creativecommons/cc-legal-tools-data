...
<head about=" ">
    <meta charset="utf-8">
    <title>С указанием авторства-Некоммерческая версии 4.0 Международная</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc/4.0/legalcode.ru" aria-current="page displayed">Legal Code for CC BY-NC 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc/4.0/deed.ru">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">С указанием авторства-Некоммерческая версии 4.0 Международная</a>
...
></i>
  ...
  <h1 class="b-header">С указанием авторства-Некоммерческая версии 4.0 Международная</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">С указанием авторства-Некоммерческая версии 4.0 Международная</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">С указанием авторства-Некоммерческая версии 4.0 Международная</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">С указанием авторства-Некоммерческая версии 4.0 Международная</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons С указанием авторства-Некоммерческая версии 4.0 Международная</h3>
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">В соответствии с условиями настоящей Публичной Лицензии Лицензиар предоставляет Вам действующую на территории всех стран мира, безвозмездную, без права сублицензирования, неисключительную, не подлежащую отмене лицензию на осуществление Лицензируемых Прав на Лицензируемый Материал путем:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1A" class="padding-left-normal padding-bottom-normal">воспроизведения и Предоставления Лицензируемого Материала целиком или в части исключительно в Некоммерческих целях; а также</li>
            

            
              <li id="s2a1B" class="padding-left-normal padding-bottom-small">создания, воспроизведения и Предоставления Адаптированного Материала исключительно в Некоммерческих целях.</li>
          ...
          <li id="s2a5" class="padding-left-normal padding-bottom-small">
            ...
            <div class="para">
              <ol type="A" class="padding-left-normal padding-vertical-normal">
                  ...
                  <li id="s2a5B_no_restrictions" class="padding-left-normal padding-bottom-small"><span style="text-decoration: underline;">Отсутствие ограничений на последующее использование</span>. Вы не можете предлагать или устанавливать какие-либо дополнительные или иные условия, или применять Эффективные Технические Меры в отношении Лицензируемого Материала, если это ограничивает осуществление Лицензируемых Прав любым получателем Лицензируемого Материала.</li>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Указание авторства</strong>.</p>
          <ol type="1" class="padding-left-normal padding-vertical-normal">
            ...
            <li id="s3a2" class="padding-left-normal padding-bottom-normal">Вы можете выполнить положения подпункта <a href="#s3a1">(1) пункта (а) Раздела 3</a> любым разумным способом в зависимости от носителя, способа и контекста, посредством которых вы Предоставляете Лицензируемый Материал. Например, разумным признается выполнение данного условия путем указания Унифицированного Идентификатора Ресурса (URI) или гиперссылки на ресурс, который содержит необходимую информацию.</li>
              ...
              <li id="s3a3" class="padding-left-normal padding-bottom-normal">По требованию Лицензиара Вы должны, насколько это практически выполнимо, удалить любую информацию, указанную в подпункте <a href="#s3a1A">(А) (1) пункта (а) Раздела 3</a>.</li>
              
                <li id="s3a4" class="padding-left-normal padding-bottom-small">Если вы Предоставляете Адаптированный Материал, созданный Вами, то Лицензия на Адаптированный Материал, которую Вы применяете, не должна ограничивать возможность получателей Адаптированного Материала придерживаться условий настоящей Публичной Лицензии.</li>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc/4.0/legalcode.ru.txt" class="link">View Legal Code as plain text</a></p>
</div>
