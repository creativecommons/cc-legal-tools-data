...
<li class="is-active"><a href="/licenses/by/4.0/deed.sl" aria-current="page displayed">License Deed for CC BY 4.0</a></li>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by/4.0/legalcode.sl">See the legal code</button>
  </div>
</div>
