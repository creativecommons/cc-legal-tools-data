...
<head about=" ">
    <meta charset="utf-8">
    <title>Creative Commons Αναφορά-Παρόμοια Διανομή 4.0</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-sa/4.0/legalcode.el" aria-current="page displayed">Legal Code for CC BY-SA 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-sa/4.0/deed.el">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Creative Commons Αναφορά-Παρόμοια Διανομή 4.0</a>
...
></i>
  ...
  <h1 class="b-header">Creative Commons Αναφορά-Παρόμοια Διανομή 4.0</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Creative Commons Αναφορά-Παρόμοια Διανομή 4.0</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Creative Commons Αναφορά-Παρόμοια Διανομή 4.0</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Creative Commons Αναφορά-Παρόμοια Διανομή 4.0</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Creative Commons Αναφορά-Παρόμοια Διανομή 4.0</h3>
      ...
      <ol type="a" class="body-big padding-left-normal">
          ...
          <li id="s1f_exceptions_and_limitations" class="padding-bottom-normal">
            ...
            <li id="s1g_license_elements_sa" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Στοιχεία της Άδειας</span> σημαίνει τα βασικά χαρακτηριστικά στοιχεία της άδειας που περιλαμβάνονται στον τίτλο μίας Δημόσιας Άδειας Creative Commons. Τα Στοιχεία της Άδειας αυτής της Δημόσιας Άδειας είναι η Αναφορά και η Παρόμοια Διανομή.</div>
            </li>
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">Σύμφωνα με τους όρους και τις προϋποθέσεις της παρούσας Δημόσιας Άδειας, ο/η Χορηγών/-ούσα την Άδεια (Αδειοδότης/-ούσα) αποφασίζει να Σας παρέχει εφεξής μια παγκόσμια, άνευ αμοιβής, χωρίς δικαίωμα υποαδειοδότησης, μη αποκλειστική, μη ανακλητή άδεια για άσκηση των Αδειοδοτούμενων Δικαιωμάτων στο Αντικείμενο της Αδειοδότησης ώστε:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1B" class="padding-left-normal padding-bottom-small">να παράγετε, να αναπαράγετε, και να πραγματοποιείτε Διαμοιρασμό του Υλικού που Προέρχεται από Προσαρμογή, Τροποποίηση ή Διασκευή (Τροποποίηση).</li>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Αναφορά</strong>.</p>
          ...
          <li id="s3b" class="padding-left-normal padding-bottom-normal"><strong>Παρόμοια Διανομή</strong>.
            ...
            <ol class="padding-left-normal">
              <li id="s3b1" class="padding-left-normal padding-bottom-normal">Η Άδεια του Διενεργούντος/-ούσας την Προσαρμογή που εφαρμόζετε πρέπει να είναι μια άδεια του νομικού προσώπου Creative Commons με τα ίδια Στοιχεία της Άδειας, της παρούσας ή μεταγενέστερης έκδοσης, ή μια Συμβατή Άδεια Αναφορά-Παρόμοια Διανομή (BY-SA).</li>
    ...
    <div class="padding-bottom-larger">
      ...
      <ol type="a" class="body-big padding-left-normal">
          <li id="s4a" class="padding-left-normal padding-bottom-normal">
            ...
            προς άρση κάθε αμφιβολίας, το Άρθρο <a href="#s2a1">2(a)(1)</a> παραχωρεί σε Εσάς το δικαίωμα να εξάγετε, να επαναχρησιμοποιείτε, να αναπαράγετε και να πραγματοποιείτε Διαμοιρασμό του συνόλου ή ουσιώδους μέρος των περιεχομένων της βάσης δεδομένων
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-sa/4.0/legalcode.el.txt" class="link">View Legal Code as plain text</a></p>
</div>
