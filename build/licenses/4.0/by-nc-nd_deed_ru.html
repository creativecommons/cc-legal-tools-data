...
<li class="is-active"><a href="/licenses/by-nc-nd/4.0/deed.ru" aria-current="page displayed">License Deed for CC BY-NC-ND 4.0</a></li>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-nd/4.0/legalcode.ru">See the legal code</button>
  </div>
</div>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">«NoDerivatives» («Без производных произведений»)</span> - Если вы <a href="#" id="some_kinds_of_mods_popup" class="helpLink">перерабатываете, преобразовываете материал или берёте его за основу для производного произведения</a>, вы не можете распространять измененный материал.
      </p>
    </div>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Без дополнительных ограничений</span> - Вы не вправе применять юридические ограничения или <a href="#" id="technological_measures_popup" class="helpLink">технологические меры</a>, создающие другим юридические препятствия в выполнении чего-либо из того, что разрешено лицензией.
      </p>
    </div>
  </div>
  <h3 class="b-header has-text-black padding-bottom-big padding-top-normal" style="font-weight: bold;">Замечания:</h3>
  <p class="has-text-black body-big padding-bottom-normal">
...
<div id="disclaimer-info-section" class="padding-bigger has-background-info-light" >
  <h4 class="padding-bottom-normal is-vcentered b-header"><i class="info icon padding-right-normal"></i>Оговорка (disclaimer)</h4>
  <p class="has-text-black padding-left-big">
    Данное краткое описание лицензии содержит только некоторые ключевые особенности и условия самой лицензии. Оно не является лицензией и не имеет юридической силы. Прежде чем начать использовать лицензированный материал, вам следует внимательно ознакомиться со всеми условиями и положениями самой лицензии, прежде чем начать использовать лицензируемый материал.
  </p>
  <p class="has-text-black padding-left-big padding-top-normal">
    Creative Commons не является юридической фирмой и не оказывает юридические услуги. Распространение, показ или предоставление ссылки на это краткое описание или на лицензию не создает отношений, аналогичных отношениям между адвокатом и клиентом, или иных отношений. 
  </p>
</div>
