...
<head about=" ">
    <meta charset="utf-8">
    <title>Uveďte původ 4.0 Mezinárodní</title>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by/4.0/legalcode.cs.txt" class="link">View Legal Code as plain text</a></p>
</div>
