...
<head about=" ">
    <meta charset="utf-8">
    <title>Naamsvermelding-GelijkDelen 4.0 Internationaal</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-sa/4.0/legalcode.nl" aria-current="page displayed">Legal Code for CC BY-SA 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-sa/4.0/deed.nl">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Naamsvermelding-GelijkDelen 4.0 Internationaal</a>
    ...
    <ul class="menu-list" >
      <li>
        <ul>
          ...
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
            <a class="is-block column" href="#s4">Artikel 4 – Sui Generis Databankenrechten.</a>
          </li>
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
...
></i>
  ...
  <h1 class="b-header">Naamsvermelding-GelijkDelen 4.0 Internationaal</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Naamsvermelding-GelijkDelen 4.0 Internationaal</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Naamsvermelding-GelijkDelen 4.0 Internationaal</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Naamsvermelding-GelijkDelen 4.0 Internationaal</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Naamsvermelding-GelijkDelen 4.0 Internationaal</h3>
      ...
      <ol type="a" class="body-big padding-left-normal">
          ...
          <li id="s1a_adapted_material" class="padding-bottom-normal">
            ...
            <li id="s1b_adapters_license" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Bewerkerslicentie</span> betekent de licentie die Je toepast op Jouw Auteursrecht en Soortgelijke Rechten in Jouw bijdrage aan het Afgeleid Materiaal met inachtneming van de hierboven vermelde voorwaarden en condities van deze Publieke Licentie.</div>
            </li>
            ...
            <li id="s1c_by_sa_compatible_license" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">BY-SA Compatibele Licentie</span> betekent een licentie die vermeld wordt op <a href="//creativecommons.org/compatiblelicenses"> creativecommons.org/compatiblelicenses</a>, goedgekeurd door Creative Commons als wezenlijk equivalent van deze Publieke Licentie.</div>
            </li>
          ...
          <li id="s1f_exceptions_and_limitations" class="padding-bottom-normal">
            ...
            <li id="s1g_license_elements_sa" class="padding-bottom-normal">
              <div class="padding-left-normal"><span style="text-decoration: underline;">Licentie-elementen</span> betekent de licentie-eigenschappen die vermeld worden in de naam van een Creative Commons Publieke Licentie. De Licentie-elementen van deze Publieke Licentie zijn Naamsvermelding en GelijkDelen.</div>
            </li>
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">Met inachtneming van de voorwaarden en condities van deze Publieke Licentie verleent de Licentiegever hierbij aan Jou een wereldwijde, royalty-vrije, niet in sublicentie te geven, niet-exclusieve, onherroepelijke licentie om de Gelicenseerde Rechten met betrekking tot het Gelicenseerde Materiaal uit te oefenen:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1A" class="padding-left-normal padding-bottom-normal">het reproduceren en Delen van het gehele of gedeeltes van het Gelicenseerde Materiaal; en</li>
            

            
              <li id="s2a1B" class="padding-left-normal padding-bottom-small">het produceren, reproduceren, en Delen van Afgeleid Materiaal.</li>
            ...
            <div class="para">
              <ol type="A" class="padding-left-normal padding-vertical-normal">
                  ...
                  <li id="s2a5A_offer" class="padding-left-normal padding-bottom-normal"><span style="text-decoration: underline;">Aanbod van de Licentiegever – Gelicenseerde Materiaal</span>. Iedere ontvanger van het Gelicenseerde Materiaal krijgt automatisch een aanbod van de Licentiegever om de Gelicenseerde Rechten uit te oefenen volgens de voorwaarden en condities van deze Publieke Licentie.</li>
                    ...
                    <li id="s2a5B_adapted_material" class="padding-left-normal padding-bottom-normal"><span style="text-decoration: underline;">Aanvullend aanbod van de Licentiegever – Afgeleid Materiaal</span>. Iedere ontvanger van Afgeleid Materiaal van Jou krijgt automatisch een aanbod van de Licentiegever om de Gelicenseerde Rechten in het Afgeleid Materiaal uit te oefenen volgens de condities van de Bewerkerslicentie die Je toepast.</li>
                  

                  <li id="s2a5C_no_restrictions" class="padding-left-normal padding-bottom-small"><span style="text-decoration: underline;">Geen verdere beperkingen</span>. Je mag geen aanvullende of afwijkende voorwaarden of condities aanbieden of opleggen, noch enige Doeltreffende Technologische Maatregelen toepassen, als daardoor de uitoefening van de Gelicenseerde Rechten door de ontvanger van het Gelicenseerde Materiaal wordt beperkt.</li>
        ...
        <li id="s3a" class="padding-left-normal padding-bottom-normal"><p><strong>Naamsvermelding</strong>.</p>
          <ol type="1" class="padding-left-normal padding-vertical-normal">
            <li id="s3a1" class="padding-left-normal padding-bottom-normal">
              <p>Als Je het Gelicenseerde Materiaal Deelt (inclusief in aangepaste vorm), ben Je verplicht:</p>
              <ol type="A" class="padding-left-normal padding-vertical-normal">
            ...
            <li id="s3a2" class="padding-left-normal padding-bottom-normal">Je kunt voldoen aan de voorwaarden in Artikel <a href="#s3a1">3(a)(1)</a> op elke redelijke wijze met inachtneming van het medium, de middelen, en context waarin je het Gelicenseerde Materiaal Deelt. Het kan bijvoorbeeld redelijk zijn om aan de voorwaarden te voldoen door een URI of hyperlink te plaatsen naar een bron die de vereiste informatie bevat.</li>
            
              <li id="s3a3" class="padding-left-normal padding-bottom-small">Op verzoek van de Licentiegever, ben je verplicht alle informatie vermeld in Artikel <a href="#s3a1A">3(a)(1)(A)</a> te verwijderen voor zover dit redelijkerwijs mogelijk is.</li>
          ...
          <li id="s3b" class="padding-left-normal padding-bottom-normal"><strong>GelijkDelen</strong>.
            <p class="padding-top-normal padding-bottom-normal">In aanvulling op de condities van Artikel <a href="#s3a">3(a)</a>, als Je Afgeleid Materiaal Deelt dat Je produceert, dan zijn de volgende condities ook van toepassing.</p>
            <ol class="padding-left-normal">
              <li id="s3b1" class="padding-left-normal padding-bottom-normal">De Bewerkerslicentie die Je toepast moet een Creative Commons-licentie zijn met dezelfde Licentie-elementen, in deze versie of een latere, of een BY-SA Compatibele Licentie.</li>
              <li id="s3b2" class="padding-left-normal padding-bottom-normal">Je moet de tekst van, of een URI of hyperlink naar, de door Jou toegepaste Bewerkerslicentie bijvoegen. Je kunt op redelijke wijze aan deze conditie voldoen gebaseerd op het medium, de middelen, en context waarin je het Afgeleid Materiaal Deelt.</li>
              <li id="s3b3" class="padding-left-normal padding-bottom-small">Je mag geen aanvullende of afwijkende voorwaarden of condities aanbieden of opleggen, noch enige Doeltreffende Technologische Maatregelen toepassen, op Afgeleid Materiaal dat het uitoefenen van de verstrekte rechten onder de Bewerkerslicentie die Je toepast beperkt.</li>
            </ol>
          </li>
    ...
    <div class="padding-bottom-larger">
      <p id="s4" class="body-bigger padding-bottom-normal"><strong>Artikel 4 – Sui Generis Databankenrechten.</strong></p>
      ...
      <ol type="a" class="body-big padding-left-normal">
          <li id="s4a" class="padding-left-normal padding-bottom-normal">
            ...
            Om twijfel te voorkomen: Artikel <a href="#s2a1">2(a)(1)</a> verleent Jou het recht om op te vragen, hergebruiken, te reproduceren en te Delen van alle, of een substantieel deel van de, inhoud van de databank;
            
          </li>
          <li id="s4b" class="padding-left-normal padding-bottom-normal">
            
              Als je alle, of een substantieel deel van de, inhoud van de databank samenvoegt tot een databank waarop je het Sui Generis Databankrecht hebt (maar niet de individuele onderdelen ervan), dan is de databank waarop je dit recht hebt Afgeleid Materiaal, inclusief voor de doeleinden van Artikel <a href="#s3b">3(b)</a>; en
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-sa/4.0/legalcode.nl.txt" class="link">View Legal Code as plain text</a></p>
</div>
