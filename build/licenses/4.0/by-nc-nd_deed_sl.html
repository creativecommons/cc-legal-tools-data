...
<li class="is-active"><a href="/licenses/by-nc-nd/4.0/deed.sl" aria-current="page displayed">License Deed for CC BY-NC-ND 4.0</a></li>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-nd/4.0/legalcode.sl">See the legal code</button>
  </div>
</div>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Brez predelav</span> - Če vsebino <a href="#" id="some_kinds_of_mods_popup" class="helpLink">predelate (remixate), uredite ali na njej gradite</a>, spremenjene vsebine ne smete razširjati.
      </p>
    </div>
