...
<li class="is-active"><a href="/licenses/by-nc-nd/4.0/deed.es" aria-current="page displayed">License Deed for CC BY-NC-ND 4.0</a></li>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-nd/4.0/legalcode.es">See the legal code</button>
  </div>
</div>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">SinObraDerivada</span> - Si <a href="#" id="some_kinds_of_mods_popup" class="helpLink">remezcla, transforma o crea</a> a partir del material, no puede difundir el material modificado.
      </p>
    </div>
