...
<head about=" ">
    <meta charset="utf-8">
    <title>Uznanie autorstwa - Bez Utworów Zależnych 4.0
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nd/4.0/legalcode.pl" aria-current="page displayed">Legal Code for CC BY-ND 4.0</a></li>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nd/4.0/deed.pl">See the deed</button>
    </div>
  </div>
</div>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Uznanie autorstwa - Bez Utworów Zależnych 4.0
Międzynarodowa</a>
...
></i>
  ...
  <h1 class="b-header">Uznanie autorstwa - Bez Utworów Zależnych 4.0
Międzynarodowa</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Uznanie autorstwa - Bez Utworów Zależnych 4.0
Międzynarodowa</h2>
</div>
        ...
        <ol class="padding-left-normal padding-vertical-normal">
          <li id="s2a1" class="padding-left-normal padding-bottom-normal">Zgodnie z postanowieniami niniejszej Licencji Publicznej, Licencjodawca udziela niniejszym Licencjobiorcy, nieodpłatnej, nieobejmującej prawa do udzielania sublicencji, niewyłącznej, nieodwołalnej licencji na korzystanie z Utworu na terytorium całego świata w odniesieniu Utworu Licencjonowanego Uprawnień Licencyjnych do:
            <ol type="A" class="padding-left-normal padding-vertical-normal">
              ...
              <li id="s2a1A" class="padding-left-normal padding-bottom-normal">zwielokrotniania i Dzielenia się Utworem Licencjonowanym w całości lub części, i</li>
      ...
      <ol type="a" class="body-big padding-left-normal">
        ...
        <li id="s6b" class="padding-left-normal padding-bottom-normal">
          ...
          <ol class="body-big padding-left-normal">
            <li id="s6b1" class="padding-left-normal padding-bottom-normal">automatycznie z datą usunięcia naruszenia, jeśli nastąpiło ono w ciągu 30 dni od odkrycia naruszenia przez Licencjobiorcę;</li>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nd/4.0/legalcode.pl.txt" class="link">View Legal Code as plain text</a></p>
</div>
