...
<head about=" ">
    <meta charset="utf-8">
    <title>Uznanie autorstwa - Na tych samych warunkach 3.0 Polska</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-sa/3.0/pl/legalcode" aria-current="page displayed">Legal Code for CC BY-SA 3.0 PL</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="pl"
            data-link="/licenses/by-sa/3.0/pl/legalcode"
          >
            polski
          </option>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-sa/3.0/pl/deed.pl">See the deed</button>
    </div>
  </div>
</div>
...
></i>
  ...
  <h1 class="b-header">Uznanie autorstwa - Na tych samych warunkach 3.0 Polska</h1>
</div>
...
></i>
  ...
  <h2 class="has-text-centered is-hidden-touch is-hidden-desktop-only padding-left-normal">CC BY-SA 3.0 PL</h2>
  <h3 class="has-text-centered is-hidden-touch">CC BY-SA 3.0 PL</h3>
  <h4 class="has-text-centered is-hidden-desktop-only is-hidden-widescreen">CC BY-SA 3.0 PL</h4>
  <h2 class="b-header has-text-centered">Uznanie autorstwa - Na tych samych warunkach 3.0 Polska</h2>
</div>
...
<h4 class="has-text-centered is-hidden-tablet padding-left-normal">CC BY-SA 3.0 PL</h4>
<h2 class="margin-bottom-larger b-header is-hidden-touch">Uznanie autorstwa - Na tych samych warunkach 3.0 Polska</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Uznanie autorstwa - Na tych samych warunkach 3.0 Polska</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Uznanie autorstwa - Na tych samych warunkach 3.0 Polska</h3>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-sa/3.0/pl/legalcode/index.txt" class="link">View Legal Code as plain text</a></p>
</div>
