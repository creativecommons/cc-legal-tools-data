...
<head about="http://creativecommons.org/licenses/by-nc-nd/3.0/pl/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nc-nd/3.0/pl/deed.pl" aria-current="page displayed">License Deed for CC BY-NC-ND 3.0 PL</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="pl"
            data-link="/licenses/by-nc-nd/3.0/pl/deed.pl"
          >
            polski
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-nd/3.0/pl/legalcode">See the legal code</button>
  </div>
</div>
...
></i>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Bez utworów zależnych</span> - <a href="#" id="some_kinds_of_mods_popup" class="helpLink">Remiksując, przetwarzając lub tworząc na podstawie</a> utworu, nie wolno rozpowszechniać zmodyfikowanych treści.
      </p>
    </div>
    ...
    <div class="column is-11">
      <p class="has-text-black body-big padding-bottom-normal">
        <span style="font-weight: bold;">Brak dodatkowych ograniczeń</span> - Nie możesz korzystać ze środków prawnych <a href="#" id="technological_measures_popup" class="helpLink">lub technologicznych</a>, które ograniczają innych w korzystaniu z utworu na warunkach określonych w licencji.
      </p>
    </div>
  </div>
  <h3 class="b-header has-text-black padding-bottom-big padding-top-normal" style="font-weight: bold;">Uwagi:</h3>
  <p class="has-text-black body-big padding-bottom-normal">
