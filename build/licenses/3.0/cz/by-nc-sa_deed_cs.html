...
<head about="http://creativecommons.org/licenses/by-nc-sa/3.0/cz/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nc-sa/3.0/cz/deed.cs" aria-current="page displayed">License Deed for CC BY-NC-SA 3.0 CZ</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="cs"
            data-link="/licenses/by-nc-sa/3.0/cz/deed.cs"
          >
            česky
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-sa/3.0/cz/legalcode">See the legal code</button>
  </div>
</div>
