...
<head about=" ">
    <meta charset="utf-8">
    <title>Αναφορά-Παρόμοια Διανομή 3.0 Ελλάδα</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-sa/3.0/gr/legalcode" aria-current="page displayed">Legal Code for CC BY-SA 3.0 GR</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="el"
            data-link="/licenses/by-sa/3.0/gr/legalcode"
          >
            Ελληνικά
          </option>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-sa/3.0/gr/deed.el">See the deed</button>
    </div>
  </div>
</div>
...
></i>
  ...
  <h1 class="b-header">Αναφορά-Παρόμοια Διανομή 3.0 Ελλάδα</h1>
</div>
...
></i>
  ...
  <h2 class="has-text-centered is-hidden-touch is-hidden-desktop-only padding-left-normal">CC BY-SA 3.0 GR</h2>
  <h3 class="has-text-centered is-hidden-touch">CC BY-SA 3.0 GR</h3>
  <h4 class="has-text-centered is-hidden-desktop-only is-hidden-widescreen">CC BY-SA 3.0 GR</h4>
  <h2 class="b-header has-text-centered">Αναφορά-Παρόμοια Διανομή 3.0 Ελλάδα</h2>
</div>
...
<h4 class="has-text-centered is-hidden-tablet padding-left-normal">CC BY-SA 3.0 GR</h4>
<h2 class="margin-bottom-larger b-header is-hidden-touch">Αναφορά-Παρόμοια Διανομή 3.0 Ελλάδα</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Αναφορά-Παρόμοια Διανομή 3.0 Ελλάδα</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Αναφορά-Παρόμοια Διανομή 3.0 Ελλάδα</h3>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-sa/3.0/gr/legalcode/index.txt" class="link">View Legal Code as plain text</a></p>
</div>
