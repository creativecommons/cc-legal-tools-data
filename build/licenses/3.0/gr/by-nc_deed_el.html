...
<head about="http://creativecommons.org/licenses/by-nc/3.0/gr/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nc/3.0/gr/deed.el" aria-current="page displayed">License Deed for CC BY-NC 3.0 GR</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="el"
            data-link="/licenses/by-nc/3.0/gr/deed.el"
          >
            Ελληνικά
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc/3.0/gr/legalcode">See the legal code</button>
  </div>
</div>
