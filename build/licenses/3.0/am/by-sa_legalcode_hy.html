...
<head about=" ">
    <meta charset="utf-8">
    <title>Հղում, համանման տարածում 3.0, Հայաստան</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-sa/3.0/am/legalcode" aria-current="page displayed">Legal Code for CC BY-SA 3.0 AM</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="hy"
            data-link="/licenses/by-sa/3.0/am/legalcode"
          >
            հայերեն
          </option>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-sa/3.0/am/deed.hy">See the deed</button>
    </div>
  </div>
</div>
...
></i>
  ...
  <h1 class="b-header">Հղում, համանման տարածում 3.0, Հայաստան</h1>
</div>
...
></i>
  ...
  <h2 class="has-text-centered is-hidden-touch is-hidden-desktop-only padding-left-normal">CC BY-SA 3.0 AM</h2>
  <h3 class="has-text-centered is-hidden-touch">CC BY-SA 3.0 AM</h3>
  <h4 class="has-text-centered is-hidden-desktop-only is-hidden-widescreen">CC BY-SA 3.0 AM</h4>
  <h2 class="b-header has-text-centered">Հղում, համանման տարածում 3.0, Հայաստան</h2>
</div>
...
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Հղում, համանման տարածում 3.0, Հայաստան</h3>
  ...
  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Հղում, համանման տարածում 3.0, Հայաստան</h3>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-sa/3.0/am/legalcode/index.txt" class="link">View Legal Code as plain text</a></p>
</div>
