...
<head about="http://creativecommons.org/licenses/by/3.0/cr/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by/3.0/cr/deed.es" aria-current="page displayed">License Deed for CC BY 3.0 CR</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="es"
            data-link="/licenses/by/3.0/cr/deed.es"
          >
            español
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by/3.0/cr/legalcode">See the legal code</button>
  </div>
</div>
...
<h4 class="has-text-centered is-hidden-tablet padding-left-normal">CC BY 3.0 CR</h4>
<h2 class="margin-bottom-larger b-header is-hidden-touch">Atribución 3.0 Costa Rica</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Atribución 3.0 Costa Rica</h3>
