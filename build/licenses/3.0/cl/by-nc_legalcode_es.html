...
<head about=" ">
    <meta charset="utf-8">
    <title>Atribución - NoComercial 3.0 Chile</title>
...
a.skip-link:focus, a.skip-link:active {
  ...
  <li class="is-active"><a href="/licenses/by-nc/3.0/cl/legalcode" aria-current="page displayed">Legal Code for CC BY-NC 3.0 CL</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="es"
            data-link="/licenses/by-nc/3.0/cl/legalcode"
          >
            español
          </option>
...
<div class="columns">
  ...
  <div class="column columns padding-vertical-normal">
    ...
    <div class="column">
      <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc/3.0/cl/deed.es">See the deed</button>
    </div>
  </div>
</div>
...
></i>
  ...
  <h1 class="b-header">Atribución - NoComercial 3.0 Chile</h1>
</div>
...
></i>
  ...
  <h2 class="has-text-centered is-hidden-touch is-hidden-desktop-only padding-left-normal">CC BY-NC 3.0 CL</h2>
  <h3 class="has-text-centered is-hidden-touch">CC BY-NC 3.0 CL</h3>
  <h4 class="has-text-centered is-hidden-desktop-only is-hidden-widescreen">CC BY-NC 3.0 CL</h4>
  <h2 class="b-header has-text-centered">Atribución - NoComercial 3.0 Chile</h2>
</div>
...
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Atribución - NoComercial 3.0 Chile</h3>
  ...
  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons Atribución - NoComercial 3.0 Chile</h3>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/by-nc/3.0/cl/legalcode/index.txt" class="link">View Legal Code as plain text</a></p>
</div>
