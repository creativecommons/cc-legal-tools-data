...
<head about="http://creativecommons.org/licenses/by-nc-nd/3.0/ec/">
    <meta charset="utf-8">
...
<li class="is-active"><a href="/licenses/by-nc-nd/3.0/ec/deed.es" aria-current="page displayed">License Deed for CC BY-NC-ND 3.0 EC</a></li>
      ...
      <select id="languages-dropdown">
        ...
        <option disabled>Select</option>
          ...
          <option
            ...
            selected
            value="es"
            data-link="/licenses/by-nc-nd/3.0/ec/deed.es"
          >
            español
          </option>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/by-nc-nd/3.0/ec/legalcode">See the legal code</button>
  </div>
</div>
...
<h4 class="has-text-centered is-hidden-tablet padding-left-normal">CC BY-NC-ND 3.0 EC</h4>
<h2 class="margin-bottom-larger b-header is-hidden-touch">Reconocimiento  – No Comercial – Sin Obras Derivadas  3.0 Ecuador</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Reconocimiento  – No Comercial – Sin Obras Derivadas  3.0 Ecuador</h3>
