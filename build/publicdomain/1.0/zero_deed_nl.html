...
<li class="is-active"><a href="/licenses/CC0/1.0/deed.nl" aria-current="page displayed">License Deed for CC0 1.0</a></li>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/CC0/1.0/legalcode.nl">See the legal code</button>
  </div>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">CC0 1.0 Universeel</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">CC0 1.0 Universeel</h3>


  
  <h3 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Geen auteursrecht</h3>
...
></i>
    ...
    <div class="column is-11">
      <p class=" body-big padding-bottom-normal">De persoon die deze akte aan een werk heeft verbonden heeft het werk <b>toegewezen</b> aan het publiek domein door wereldwijd zijn of haar rechten op het werk onder het auteursrecht, inclusief alle bijbehorende en naburige rechten, af te staan, voor zover door de wet is toegestaan. </p>
      <p class=" body-big padding-bottom-normal">Je mag het werk zonder toestemming kopiëren, veranderen, verspreiden en uitvoeren, zelfs voor commerciële doeleinden. Zie <b>Overige Informatie</b> beneden.</p>
    </div>
  </div>

    
    
  <h3 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Overige informatie</h3>
  <div class="columns is-multiline">
    ...
    <div class="column is-11">
      <ul>
        ...
        <li><p class=" body-big padding-bottom-normal">Tenzij nadrukkelijk anders is vermeld, geeft de persoon die een werk in verband met deze akte geeft geen garanties over het werk, en wijst elke aansprakelijkheid af voor alle toepassingen van het werk, voor zover toegestaan door de toepasselijke wetgeving.</li>
        <li><p class=" body-big padding-bottom-normal">Bij het gebruiken van of verwijzing naar het werk, mag je geen <a href="" class="helpLink" id="endorsement">goedkeuring</a> van de auteur of rechthebbende impliceren.</li>
      </ul>
    </div>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Overige rechten</h4>
  <div>
    <p>Het gebruik van een werk waarop geen bekende auteursrechtelijke beperkingen rusten kan anderszins gereguleerd of beschermd zijn. Het werk of het gebruik daarvan kan onderworpen zijn aan wetten die persoonsgegevens beschermen,  portretrechten of privacyrechten die een persoon in staat stellen om te beschikken over hoe zijn stem, beeltenis of gelijkenis wordt gebruikt, of andere beperkingen onder het toepasselijke recht.</p>
    <p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#When_are_publicity_rights_relevant.3F">Meer weten</a>.</p>
  </div>


  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Goedkeuring</h4>
  <div>
    <p>In sommige jurisdicties kan het onrechtmatig zijn om ten onrechte te suggereren dat een maker, uitgever of iemand anders het gebruik van een werk goedkeurt. </p>
    <p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Do_I_need_to_be_aware_of_anything_else_when_providing_attribution_or_credit.3F">Meer weten</a>.</p>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Citatie</h4>
  <div>
    <p>
      Kopieer en plak de HTML om het werk gemakkelijk op je webpagina te citeren.
    </p>
    <p>
      <a href="https://wiki.creativecommons.org/CC0_FAQ#Do_I_have_to_attribute_the_person_who_applied_CC0_to_their_work.3F">Meer weten</a>
    </p>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Wie bevestigd dit?</h4>
  <div>
    <p>
...
<div id="disclaimer-info-section" class="padding-bigger has-background-info-light" >
  <h4 class="padding-bottom-normal is-vcentered b-header"><i class="info icon padding-right-normal"></i>Vrijwaring</h4>

    <p>De Commons Akte is geen juridisch instrument. Het is een handig hulpmiddel voor een beter begrip van de CC0 Juridische Overeenkomst, een voor mensen leesbare weergave van een aantal kernbegrippen daaruit. Beschouw het als de gebruiksvriendelijke interface van de onderliggende CC0 Juridische Overeenkomst. Deze Akte zelf heeft geen juridische betekenis, en de inhoud komt niet voor in de CC0.</p><p> Creative Commons is geen advocatenpraktijk en verleent geen juridische diensten. Het verspreiden, weergeven, of verwijzen naar deze Commons Akte schept geen advocaat-cliënt relatie.</p><p> Creative Commons heeft de auteursrechtelijke status van werken waarop de CC0 is toegepast niet geverifieerd. CC geeft geen vrijwaringen met betrekking tot werken of hun auteursrechtelijke status in enige jurisdictie, en sluit alle aansprakelijkheid uit voor ieder gebruik van elk werk.</p>

    <p>Dit is een voor mensen leesbare samenvatting van de <a href="./legalcode"> Legal Code (lees de volledige tekst)</a>.</p>
