...
<li class="is-active"><a href="/licenses/CC0/1.0/deed.es" aria-current="page displayed">License Deed for CC0 1.0</a></li>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/CC0/1.0/legalcode.es">See the legal code</button>
  </div>
</div>
...
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">CC0 1.0 Universal</h3>
  ...
  <h3 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Sin derechos de propiedad intelectual</h3>
...
></i>
    ...
    <div class="column is-11">
      <p class=" body-big padding-bottom-normal">La persona que ha asociado una obra a éste documento ha dedicado la misma al dominio publico, liberándola de forma mundial y en la medida que lo permita la ley, de todos sus derechos  de propiedad intelectual,   incluyendo todos los derechos conexos.</p>
      <p class=" body-big padding-bottom-normal">Puede copiar, modificar, distribuir la obra y hacer comunicación pública, incluso para fines comerciales, sin pedir permiso. <b>Más información</b> debajo.</p>
    </div>
  </div>

    
    
  <h3 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Más información</h3>
  <div class="columns is-multiline">
    ...
    <div class="column is-11">
      <ul>
        ...
        <li><p class=" body-big padding-bottom-normal">A menos que se exprese de otra manera, la persona que ha asociado esta obra con este resumen no ofrece ninguna garantía respecto a la obra y renuncia a cualquier responsabilidad por culaquier uso de la obra, en la máxima medida permitida por la ley aplicable.</li>
        <li><p class=" body-big padding-bottom-normal">Cuando use o cite la obra, no debería dar a entender que dispone de ningún tipo de <a href="" class="helpLink" id="endorsement">apoyo</a> por parte del autor o del afirmador.</li>
      </ul>
    </div>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Otros derechos</h4>
  <div>
    <p>El uso de una obra los derechos de  propiedad intelectual de la cual son desconocidos, puede ocasionar que  la misma resulte estar regulada o limitada.  La obra o su uso puede estar sujeto a leyes de protección de datos, publicidad  o derechos de privacidad que permitan a una persona controlar el uso de su  voz , imagen o apariencia, así como otras restricciones o limitaciones  bajo la ley aplicable.</p>
    <p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#When_are_publicity_rights_relevant.3F">Aprenda más</a>.</p>
  </div>


  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Patrocinio</h4>
  <div>
    <p>En algunas jurisdicciones, el hecho de dar a entender de manera errónea que un autor, una editorial o cualquier otra persona respalda el uso que hace usted de una obra, puede ser ilegal. </p>
    <p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Do_I_need_to_be_aware_of_anything_else_when_providing_attribution_or_credit.3F">Aprenda más</a>.</p>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Cita</h4>
  <div>
    <p>
      Copie y pegue en su página web el código HTML proporcionado para facilitar la cita de su obra.
    </p>
    <p>
      <a href="https://wiki.creativecommons.org/CC0_FAQ#Do_I_have_to_attribute_the_person_who_applied_CC0_to_their_work.3F">Aprenda más</a>
    </p>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">¿Quien lo afirma?</h4>
  <div>
    <p>
      El cedente es aquella persona que, en la medida que la ley lo permita, cede sus derechos de forma global mediante CC0, Puede ser el autor original del trabajo o cualquier otra persona que pueda haber tenido derechos de  propiedad intelectual o derechos conexos sobre el trabajo.
    </p>
  </div>
</div>
...
<div id="disclaimer-info-section" class="padding-bigger has-background-info-light" >
  <h4 class="padding-bottom-normal is-vcentered b-header"><i class="info icon padding-right-normal"></i>Advertencia</h4>

    <p>El resumen (Commons Deed) no es un instrumento legal. Simplemente es una referencia para entender el código legal de CC0, una descripción humanamente comprensible de sus términos clave. Piensa en él como una interficie amigable para acceder al código legal interno de CC0. El resumen por si solo no tiene valor legal y sus contenidos no aparecen en CC0.</p><p>Creative Commons no es un bufete de abogados y no ofrece servicios jurídicos. La distribución, la muestra, o el enlace de este resumen no crea ninguna relación abogado-cliente.</p><p> Creative Commons no verifica el estado de los derechos de ninguna de las obras sujetas a CC0. CC no ofrece ninguna garantía sobre la obra y su estado en cualquier jurisdicción y exime toda responsabilidad por cualquier uso que se haga de la obra. </p>

    <p>Esto es un resumen del <a href="./legalcode">Código Legal (léase el texto completo)</a> que cualquier ser humano puede comprender.</p>
