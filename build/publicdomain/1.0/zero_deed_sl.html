...
<li class="is-active"><a href="/licenses/CC0/1.0/deed.sl" aria-current="page displayed">License Deed for CC0 1.0</a></li>
...
<div class="level container">
  <div class="level-item level-right">
    <button id="next-btn" class="button tiny is-pulled-right" data-href="/licenses/CC0/1.0/legalcode.sl">See the legal code</button>
  </div>
</div>
...
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">CC0 1.0 Univerzalna</h3>
  ...
  <h3 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Brez avtorskih pravic</h3>
...
></i>
    ...
    <div class="column is-11">
      <p class=" body-big padding-bottom-normal">Oseba, ki je povezala delo s tem povzetkom licence je <b>posvetila</b> delo javni domeni, s tem ko se je globalno odpovedala vsem svojim avtorskim in sorodnim pravicam, v kolikor to zakon dopušča.</p>
      <p class=" body-big padding-bottom-normal">Delo lahko kopirate, spreminjate, razširjate in izvajate, tudi v komercialne namene, brez prošnje za dovoljenje. Glejte <b>Druge informacije</b> spodaj.</p>
    </div>
  </div>

    
    
  <h3 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Ostale podrobnosti</h3>
  <div class="columns is-multiline">
    ...
    <div class="column is-11">
      <ul>
        ...
        <li><p class=" body-big padding-bottom-normal">V kolikor ni izrecno dogovorjeno drugače, oseba, ki je povezala delo s tem povzetkom licence, ne daje nikakršnih jamstev glede dela, in uporabnikom dela ne odgovarja za nikakršno škodo, razen v primerih, ko izključitev odgovornosti ni dopustna po zakonu.</li>
        <li><p class=" body-big padding-bottom-normal">Ko uporabljate ali navajate delo, ne smete namigovati na <a href="" class="helpLink" id="endorsement">podporo</a> avtorja ali potrditelja.</li>
      </ul>
    </div>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Ostale pravice</h4>
  <div>
    <p>Tudi če je delo prosto znanih avtorsko-pravnih omejitev, je lahko njegova uporaba še vedno drugače urejena ali omejena. Delo ali njegovo uporabo lahko omejujejo zakoni, ki urejajo varstvo osebnih podatkov, osebnostne pravice ali zasebnost. V takih primerih lahko po zakonu oseba, na primer, še vedno odloča kako se sme uporabljati njen glas, sliko ali podobnost.</p>
    <p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#When_are_publicity_rights_relevant.3F">Več o tem</a>.</p>
  </div>


  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Podpora</h4>
  <div>
    <p>V nekaterih jurisdikcijah je napačno namigovanje, da avtor, založnik ali kdor koli drug podpira vašo uporabo dela, lahko protipravno.</p>
    <p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Do_I_need_to_be_aware_of_anything_else_when_providing_attribution_or_credit.3F">Več o tem</a>.</p>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Navedek</h4>
  <div>
    <p>
      Kopirajte in prilepite kodo HTML na svojo spletno stran za preprosto citiranje dela.
    </p>
    <p>
      <a href="https://wiki.creativecommons.org/CC0_FAQ#Do_I_have_to_attribute_the_person_who_applied_CC0_to_their_work.3F">Več o tem</a>
    </p>
  </div>

  <h4 class="b-header  padding-bottom-big padding-top-normal" style="font-weight: bold;">Kdo je potrditelj?</h4>
  <div>
    <p>
...
<div id="disclaimer-info-section" class="padding-bigger has-background-info-light" >
  <h4 class="padding-bottom-normal is-vcentered b-header"><i class="info icon padding-right-normal"></i>Izjava o omejitvi odgovornosti</h4>

    <p>Povzetek licence ni pravno orodje. Je preprosto le priročna referenca za razumevanje Celotnega pravnega besedila CC0, je izraz ključnih pogojev, berljiv za uporabnike. Gre za uporabniku prijazen vmesnik do Celotnega pravnega besedila CC0. Ta povzetek sam po sebi nima pravne veljave in njegova vsebina se v dejanskem besedilu CC0 ne pojavlja.</p> <p>Creative Commons ni odvetniška pisarna in ne ponuja pravniških storitev. Razširjanje, prikazovanje ali povezovanje na ta Povzetkom licence ne ustvarja razmerja odvetnik-stranka.</p><p>Creative Commons ni preveril avtorsko-pravni status nobenega dela, ki je objavljeno pod CC0. CC ne daje nikakršnih jamstev glede nobenega dela ali avtorsko-pravnega statusa le-tega v nobeni jurisdikciji in ne odgovarja za nobeno škodo, ki bi nastala zaradi kakršnekoli uporabe kateregakoli dela.</p>

    <p>To je človeško berljiv povzetek <a href="./legalcode">Pravne kode (premerite celotno besedilo)</a>.</p>
