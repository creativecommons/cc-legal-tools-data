...
<head about=" ">
    <meta charset="utf-8">
    <title>CC0 1.0 Universiell</title>
...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
      ...
      <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">CC0 1.0 Universiell</a>
      ...
      <li>
        <ul>
          ...
          <li class="columns">
            ...
            <a class="is-block column" href="#sop">Avsiktsförklaring</a>
          </li>
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
            <a class="is-block column" href="#copyright">1. Upphovsrätt och Närstående Rättigheter.</a>
          </li>
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
            <a class="is-block column" href="#waiver">2. Avståendeförklaring.</a>
          </li>
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
            <a class="is-block column" href="#fallback">3. Reserverad Publik Licens.</a>
          </li>
          <li class="columns">
            <div class="body-bigger is-inline-block column is-1 py-0 my-0">&#8226;</div>
            <a class="is-block column" href="#limitations">4. Begränsningar och Friskrivningar.</a>
          </li>
...
></i>
  ...
  <h1 class="b-header">CC0 1.0 Universiell</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">CC0 1.0 Universiell</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">CC0 1.0 Universiell</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">CC0 1.0 Universiell</h3>

  <div id="plain-text-marker">
    <h3 class="padding-bottom-normal b-header">Creative Commons CC0 1.0 Universiell</h3>
  ...
  <div class="padding-bottom-larger">
    ...
    <div id="sop" class="padding-bottom-larger">
      ...
      <div id="copyright" class="padding-bottom-larger">
        <p class="body-bigger padding-bottom-normal"><strong>1. Upphovsrätt och Närstående Rättigheter.</strong></p>

        <p class="body-big padding-bottom-normal">Ett Verk som gjorts tillgängligt under CC0 kan vara skyddat av upphovsrätt och relaterade eller närstående rättigheter (“Upphovsrätt och Relaterade Rättigheter”). Upphovsrätt och Relaterade Rättigheter innefattar, men är inte begränsat till, följande:</p>

        <ol type="a" class="body-big padding-left-normal">
          <li class="padding-left-normal padding-bottom-normal">rätten att reproducera, bearbeta, sprida framföra, visa, kommunicera, och översätta ett Verk;</li>
          <li class="padding-left-normal padding-bottom-normal">ideella rättigheter som förbehållna av upphovspersonen/upphovspersonerna och/eller framföraren/framförarna;</li>
          <li class="padding-left-normal padding-bottom-normal">publicitet och personlig integritet som rör en persons bild eller utseende återgivet i ett Verk (publicity and privacy rights);</li>
          <li class="padding-left-normal padding-bottom-normal">rättigheter som skyddar mot illojal konkurrens gällande ett Verk, med debegränsningar som anges i punkt 4 (a), nedan;</li>
          <li class="padding-left-normal padding-bottom-normal">rättigheter till skydd för extrahering, spridning, användning och återanvändning av data i ett Verk;</li>
          <li class="padding-left-normal padding-bottom-normal">databasrättigheter i likhet med de som framgår av Europaparlamentets och rådets direktiv 96/9/EU av den 11 mars 1996 om rättsligt skydd för databaser,och nationella implementeringar av det, inklusive uppdaterade eller nya versioner av det); och</li>
          <li class="padding-left-normal padding-bottom-normal">andra liknande, likvärdiga eller motsvarande rättigheter i hela världen som grundas på tillämplig lag eller fördrag, och alla nationella implementeringar därav.</li>
        </ol>
      </div>
      ...
      <div id="fallback" class="padding-bottom-larger">
        <p class="body-bigger padding-bottom-normal"><strong>3. Reserverad Publik Licens.</strong></p>

        <p class="body-big padding-bottom-normal">Om någon del av Avståendeförklaringen av någon anledning skulle bedömas sakna rättslig verkan eller inte uppnå önskad effekt enligt tillämplig lag, ska Avståendeförklaringen fortsätta gälla i största möjliga utsträckning med beaktande av Upplåtarens uttryckliga Avsiktsförklaring. Utöver vad som bedöms förenligt med Avståendeförklaringen, upplåter Upplåtaren härmed till varje berörd person en royaltyfri, icke överlåtbar, icke vidarelicensierbar, icke exklusiv, oåterkallerlig och ovillkorlig licens att utöva Upplåtarens Upphovsrätt och Relaterade Rättigheter i Verket (i) i samtliga områden i världen, (ii) under den maximala skyddstiden enligt tillämplig lag eller fördrag (inklusive framtida förlängningar), (iii) i varje nu existerande och framtida medium och oavsett antal kopior, och (iv) för vilket syfte som helst, inklusive men utan begränsning för kommersiellt, reklam- och marknadsföringsmässigt syfte (“Licensen”). Licensen ska anses gälla från det datum då CC0 applicerades av Upplåtaren på Verket. Skulle någon del av Licensen av någon anledning bedömas sakna rättslig verkan eller effekt enligt tillämplig lag, ska sådan partiell ogiltighet eller ineffektivitet inte ogiltigförklara resterande del av Licensen, och i sådant fall bekräftar härmed Upplåtaren att han eller hon inte kommer att (i)utöva någon av hans eller hennes återstående Upphovsrätt och Relaterade Rättigheter i Verket som kvarstår i Verket eller (ii)framställa några relaterade anspråk och anledning att vidta rättsliga åtgärder med hänsyn till Verket, i något av fallen som motsätter sig Upplåtarens uttryckliga Avsiktsförklaring.</p>
      </div>
      ...
      <div id="limitations" class="padding-bottom-larger">
        <p class="body-bigger padding-bottom-normal"><strong>4. Begränsningar och Friskrivningar.</strong></p>

        <ol type="a" class="body-big padding-left-normal">
          <li class="padding-bottom-normal">
            <div class="padding-left-normal">Inga varumärkesrättsliga eller patenträttsliga rättigheter som innehas av Upplåtaren avstås, överges, ges upp eller licensieras eller påverkas i övrigt av detta dokument.</div>
          </li>
          <li class="padding-bottom-normal">
            <div class="padding-left-normal">Upplåtaren erbjuder Verket i befintligt skick och lämnar inga utfästelser eller några garantier av något slag gällande Verket, uttryckligen, undersförstått, lagstadgat eller annars, inklusive utan begränsning gällande garantier om äganderätt äganderätt, marknadsmässig kvalitet, lämplighet för ett särskild ändamål, icke intrångsskapande, eller frånvaro av lantenta eller andra fel, tillförlitlighet, eller förekomsten eller frånvaron av fel, oavsett om de hade kunnat upptäckas eller ej, allt detta i den utsträckning det är möjligt enligt tillämplig lag.</div>
          </li>
          <li class="padding-bottom-normal">
            <div class="padding-left-normal">Upplåtaren friskriver sig från ansvar för att klarera rättigheter med andra personer vars rättigheter kan ingå i Verket eller någon form av användning därav, inklusive, utan begränsning, annan persons Upphovsrätt och Relaterade Rättigheter till Verket. Upplåtaren friskriver sig vidare från ansvar för att inhämta varje form av nödvändigt samtycke, tillåtelse eller andra rättigheter som krävs för varje form av användning Verket.</div>
          </li>
          <li class="padding-bottom-normal">
            <div class="padding-left-normal">Upplåtaren är införstådd med och bekräftar att Creative Commons inte är part enligt detta dokument och inte har någon skyldighet eller förpliktelse med hänsyn till denna CC0 eller användning av Verket.</div>
          </li>
        </ol>
      </div>
    </div>
...
<div id="legal-code-plain-text" style="font-weight: bold;" class="padding-vertical-normal" >
  <p class="body-big"><a id="view-plain-text" href="/licenses/CC0/1.0/legalcode.sv.txt" class="link">View Legal Code as plain text</a></p>
</div>
